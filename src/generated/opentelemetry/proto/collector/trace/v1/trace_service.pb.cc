...
inline PROTOBUF_NDEBUG_INLINE ExportTraceServiceRequest::Impl_::Impl_(
    ...
    const Impl_& from, const ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceRequest& from_msg)
...
inline void* ExportTraceServiceRequest::PlacementNew_(const void*, void* mem,
                                        ::google::protobuf::Arena* arena) {
...
const ::_pbi::TcParseTable<0, 1, 1, 0, 2> ExportTraceServiceRequest::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
...
inline PROTOBUF_NDEBUG_INLINE ExportTraceServiceResponse::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceResponse& from_msg)
...
ExportTraceServiceResponse::ExportTraceServiceResponse(
  ...
  _impl_.partial_success_ = (cached_has_bits & 0x00000001u) ? ::google::protobuf::Message::CopyConstruct<::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess>(
...
inline void* ExportTraceServiceResponse::PlacementNew_(const void*, void* mem,
                                        ::google::protobuf::Arena* arena) {
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<0, 1, 1, 0, 2> ExportTraceServiceResponse::_table_ = {
  {
  ...
  if (cached_has_bits & 0x00000001u) {
    ...
    if (_this->_impl_.partial_success_ == nullptr) {
      _this->_impl_.partial_success_ =
          ::google::protobuf::Message::CopyConstruct<::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess>(arena, *from._impl_.partial_success_);
    } else {
...
inline PROTOBUF_NDEBUG_INLINE ExportTracePartialSuccess::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena* arena,
    const Impl_& from, const ::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess& from_msg)
...
inline void* ExportTracePartialSuccess::PlacementNew_(const void*, void* mem,
                                        ::google::protobuf::Arena* arena) {
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<1, 2, 0, 86, 2> ExportTracePartialSuccess::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(ExportTracePartialSuccess, _impl_.rejected_spans_), 63>(),
