...
inline constexpr ExportTracePartialSuccess::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : error_message_(&::google::protobuf::internal::fixed_address_empty_string, ::_pbi::ConstantInitialized()),
      rejected_spans_ {::int64_t {0}}, _cached_size_ {0} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    ExportTracePartialSuccessDefaultTypeInternal _ExportTracePartialSuccess_default_instance_;

inline constexpr ExportTraceServiceResponse::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : _cached_size_ {0}, partial_success_ {nullptr} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    ExportTraceServiceResponseDefaultTypeInternal _ExportTraceServiceResponse_default_instance_;

inline constexpr ExportTraceServiceRequest::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    ExportTraceServiceRequestDefaultTypeInternal _ExportTraceServiceRequest_default_instance_;
} // namespace v1
} // namespace trace
} // namespace collector
} // namespace proto
...
const ::uint32_t TableStruct_opentelemetry_2fproto_2fcollector_2ftrace_2fv1_2ftrace_5fservice_2eproto::offsets
    [] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ~0u, // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::collector::trace::v1::ExportTraceServiceRequest,
                              _internal_metadata_),
        ~0u, // no _extensions_
        ~0u, // no _oneof_case_
        ...
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::collector::trace::v1::ExportTraceServiceResponse,
                              _impl_._has_bits_),
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::collector::trace::v1::ExportTraceServiceResponse,
                              _internal_metadata_),
        ~0u, // no _extensions_
        ...
        0,
        ~0u, // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess,
                              _internal_metadata_),
        ~0u, // no _extensions_
        ~0u, // no _oneof_case_
        ~0u, // no _weak_field_map_
...
const char descriptor_table_protodef_opentelemetry_2fproto_2fcollector_2ftrace_2fv1_2ftrace_5fservice_2eproto
    [] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::_pbi::DescriptorTable
    *const descriptor_table_opentelemetry_2fproto_2fcollector_2ftrace_2fv1_2ftrace_5fservice_2eproto_deps[1] = {
...
ExportTraceServiceRequest::ExportTraceServiceRequest(::google::protobuf::Arena *arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
...
inline PROTOBUF_NDEBUG_INLINE ExportTraceServiceRequest::Impl_::Impl_(
...
ExportTraceServiceRequest::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
...
inline void *ExportTraceServiceRequest::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
constexpr auto ExportTraceServiceRequest::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(ExportTraceServiceRequest, _impl_.resource_spans_) +
	        decltype(ExportTraceServiceRequest::_impl_.resource_spans_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(ExportTraceServiceRequest),
		                                                              alignof(ExportTraceServiceRequest), *arena_bits);
	} else {
...
const ::google::protobuf::internal::ClassDataFull ExportTraceServiceRequest::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<ExportTraceServiceRequest>(),
        &ExportTraceServiceRequest::ByteSizeLong,
...
const ::google::protobuf::internal::ClassData *ExportTraceServiceRequest::GetClassData() const {
    ...
    ExportTraceServiceRequest::_table_ = {
        {
            ...
            ::_pbi::TcParser::GetTable<
                ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceRequest>(), // to_prefetch
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *ExportTraceServiceRequest::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                                         ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const ExportTraceServiceRequest &this_ = static_cast<const ExportTraceServiceRequest &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *ExportTraceServiceRequest::_InternalSerialize(::uint8_t *target,
...
void ExportTraceServiceRequest::InternalSwap(ExportTraceServiceRequest *PROTOBUF_RESTRICT other) {
	using std::swap;
...
ExportTraceServiceResponse::ExportTraceServiceResponse(::google::protobuf::Arena *arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
inline PROTOBUF_NDEBUG_INLINE ExportTraceServiceResponse::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena *arena, const Impl_ &from,
...
ExportTraceServiceResponse::ExportTraceServiceResponse(::google::protobuf::Arena *arena,
	...
	_impl_.partial_success_ = (cached_has_bits & 0x00000001u)
...
inline PROTOBUF_NDEBUG_INLINE
ExportTraceServiceResponse::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                         ::google::protobuf::Arena *arena)
    : _cached_size_ {0} {
}
...
inline void *ExportTraceServiceResponse::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull ExportTraceServiceResponse::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<ExportTraceServiceResponse>(),
        &ExportTraceServiceResponse::ByteSizeLong,
...
const ::google::protobuf::internal::ClassData *ExportTraceServiceResponse::GetClassData() const {
	::google::protobuf::internal::PrefetchToLocalCache(&_class_data_);
	::google::protobuf::internal::PrefetchToLocalCache(_class_data_.tc_table);
	return _class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 1, 1, 0, 2>
    ExportTraceServiceResponse::_table_ = {
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceResponse>(), // to_prefetch
#endif // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
        ...
        {{
            // .opentelemetry.proto.collector.trace.v1.ExportTracePartialSuccess partial_success = 1;
            {PROTOBUF_FIELD_OFFSET(ExportTraceServiceResponse, _impl_.partial_success_), _Internal::kHasBitsOffset + 0,
             0, (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
        }},
        {{
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *ExportTraceServiceResponse::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                                          ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const ExportTraceServiceResponse &this_ = static_cast<const ExportTraceServiceResponse &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *ExportTraceServiceResponse::_InternalSerialize(::uint8_t *target,
                                                          ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	if (cached_has_bits & 0x00000001u) {
		target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
		    1, *this_._impl_.partial_success_, this_._impl_.partial_success_->GetCachedSize(), target, stream);
	}
...
::size_t ExportTraceServiceResponse::ByteSizeLong() const {
...

	{
		...
		cached_has_bits = this_._impl_._has_bits_[0];
		if (cached_has_bits & 0x00000001u) {
			total_size += 1 + ::google::protobuf::internal::WireFormatLite::MessageSize(*this_._impl_.partial_success_);
		}
	}
	return this_.MaybeComputeUnknownFieldsSize(total_size, &this_._impl_._cached_size_);
}
...
void ExportTraceServiceResponse::MergeImpl(::google::protobuf::MessageLite &to_msg,
	...
	if (cached_has_bits & 0x00000001u) {
		...
		if (_this->_impl_.partial_success_ == nullptr) {
			_this->_impl_.partial_success_ = ::google::protobuf::Message::CopyConstruct<
			    ::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess>(arena,
			                                                                             *from._impl_.partial_success_);
		} else {
...
void ExportTraceServiceResponse::InternalSwap(ExportTraceServiceResponse *PROTOBUF_RESTRICT other) {
	using std::swap;
	_internal_metadata_.InternalSwap(&other->_internal_metadata_);
...
ExportTracePartialSuccess::ExportTracePartialSuccess(::google::protobuf::Arena *arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
inline PROTOBUF_NDEBUG_INLINE ExportTracePartialSuccess::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena *arena, const Impl_ &from,
    const ::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess &from_msg)
    : error_message_(arena, from.error_message_), _cached_size_ {0} {
}
...
inline PROTOBUF_NDEBUG_INLINE
ExportTracePartialSuccess::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                        ::google::protobuf::Arena *arena)
    : error_message_(arena), _cached_size_ {0} {
}
...
inline void *ExportTracePartialSuccess::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull ExportTracePartialSuccess::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<ExportTracePartialSuccess>(),
        &ExportTracePartialSuccess::ByteSizeLong,
...
const ::google::protobuf::internal::ClassData *ExportTracePartialSuccess::GetClassData() const {
	::google::protobuf::internal::PrefetchToLocalCache(&_class_data_);
	::google::protobuf::internal::PrefetchToLocalCache(_class_data_.tc_table);
	return _class_data_.base();
}
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<1, 2, 0, 86, 2>
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess>(), // to_prefetch
#endif // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
            // string error_message = 2;
            {::_pbi::TcParser::FastUS1,
             {18, 63, 0, PROTOBUF_FIELD_OFFSET(ExportTracePartialSuccess, _impl_.error_message_)}},
            // int64 rejected_spans = 1;
            {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t,
                                                    offsetof(ExportTracePartialSuccess, _impl_.rejected_spans_), 63>(),
             {8, 63, 0, PROTOBUF_FIELD_OFFSET(ExportTracePartialSuccess, _impl_.rejected_spans_)}},
        }},
        {{65535, 65535}},
        {{
            // int64 rejected_spans = 1;
            {PROTOBUF_FIELD_OFFSET(ExportTracePartialSuccess, _impl_.rejected_spans_), 0, 0,
             (0 | ::_fl::kFcSingular | ::_fl::kInt64)},
            // string error_message = 2;
            {PROTOBUF_FIELD_OFFSET(ExportTracePartialSuccess, _impl_.error_message_), 0, 0,
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *ExportTracePartialSuccess::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                                         ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const ExportTracePartialSuccess &this_ = static_cast<const ExportTracePartialSuccess &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *ExportTracePartialSuccess::_InternalSerialize(::uint8_t *target,
                                                         ::google::protobuf::io::EpsCopyOutputStream *stream) const {
...
::size_t ExportTracePartialSuccess::ByteSizeLong() const {
	...
	::_pbi::Prefetch5LinesFrom7Lines(&this_);
	{
		...
		// int64 rejected_spans = 1;
		if (this_._internal_rejected_spans() != 0) {
			total_size += ::_pbi::WireFormatLite::Int64SizePlusOne(this_._internal_rejected_spans());
		}
	}
	return this_.MaybeComputeUnknownFieldsSize(total_size, &this_._impl_._cached_size_);
}
...
void ExportTracePartialSuccess::InternalSwap(ExportTracePartialSuccess *PROTOBUF_RESTRICT other) {
	using std::swap;
	auto *arena = GetArena();
