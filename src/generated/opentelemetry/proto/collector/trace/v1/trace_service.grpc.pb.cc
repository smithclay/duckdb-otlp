...
std::unique_ptr<TraceService::Stub> TraceService::NewStub(const std::shared_ptr<::grpc::ChannelInterface> &channel,
...
TraceService::Stub::Stub(const std::shared_ptr<::grpc::ChannelInterface> &channel, const ::grpc::StubOptions &options)
    : channel_(channel), rpcmethod_Export_(TraceService_method_names[0], options.suffix_for_stats(),
                                           ::grpc::internal::RpcMethod::NORMAL_RPC, channel) {
}

::grpc::Status
TraceService::Stub::Export(::grpc::ClientContext *context,
	...
	return ::grpc::internal::BlockingUnaryCall<::opentelemetry::proto::collector::trace::v1::ExportTraceServiceRequest,
	                                           ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceResponse,
	                                           ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
	    channel_.get(), rpcmethod_Export_, context, request, response);
}

void TraceService::Stub::async::Export(
    ::grpc::ClientContext *context,
    const ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceRequest *request,
    ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceResponse *response,
    std::function<void(::grpc::Status)> f) {
	::grpc::internal::CallbackUnaryCall<::opentelemetry::proto::collector::trace::v1::ExportTraceServiceRequest,
	                                    ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceResponse,
	                                    ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
...
TraceService::Stub::PrepareAsyncExportRaw(
    ::grpc::ClientContext *context,
    const ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceRequest &request,
    ::grpc::CompletionQueue *cq) {
	return ::grpc::internal::ClientAsyncResponseReaderHelper::Create<
	    ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceResponse,
	    ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceRequest, ::grpc::protobuf::MessageLite,
	    ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_Export_, context, request);
}

::grpc::ClientAsyncResponseReader<::opentelemetry::proto::collector::trace::v1::ExportTraceServiceResponse> *
TraceService::Stub::AsyncExportRaw(
    ::grpc::ClientContext *context,
    const ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceRequest &request,
    ::grpc::CompletionQueue *cq) {
...
TraceService::Service::Service() {
	AddMethod(new ::grpc::internal::RpcServiceMethod(
	    ...
	    new ::grpc::internal::RpcMethodHandler<TraceService::Service,
	                                           ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceRequest,
	                                           ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceResponse,
	                                           ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
	        [](TraceService::Service *service, ::grpc::ServerContext *ctx,
...
::grpc::Status
TraceService::Service::Export(::grpc::ServerContext *context,
                              const ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceRequest *request,
                              ::opentelemetry::proto::collector::trace::v1::ExportTraceServiceResponse *response) {
	(void)context;
	(void)request;
