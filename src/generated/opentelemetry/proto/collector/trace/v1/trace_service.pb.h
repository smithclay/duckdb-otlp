...
public:
	...
	void operator delete(ExportTracePartialSuccess *msg, std::destroying_delete_t) {
		SharedDtor(*msg);
	...
	static inline const ExportTracePartialSuccess *internal_default_instance() {
		return reinterpret_cast<const ExportTracePartialSuccess *>(&_ExportTracePartialSuccess_default_instance_);
	}
	...
	ExportTracePartialSuccess *New(::google::protobuf::Arena *arena = nullptr) const {
...
public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
	void operator delete(ExportTraceServiceResponse *msg, std::destroying_delete_t) {
		SharedDtor(*msg);
	...
	ExportTraceServiceResponse *New(::google::protobuf::Arena *arena = nullptr) const {
...
public:
	...
	PROTOBUF_NODISCARD ::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess *
	...
	void unsafe_arena_set_allocated_partial_success(
	    ::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess *value);
...
public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
	void operator delete(ExportTraceServiceRequest *msg, std::destroying_delete_t) {
		SharedDtor(*msg);
	...
	static inline const ExportTraceServiceRequest *internal_default_instance() {
		return reinterpret_cast<const ExportTraceServiceRequest *>(&_ExportTraceServiceRequest_default_instance_);
	}
	...
	ExportTraceServiceRequest *New(::google::protobuf::Arena *arena = nullptr) const {
...
ExportTraceServiceRequest::mutable_resource_spans(int index) ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
ExportTraceServiceRequest::resource_spans(int index) const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::opentelemetry::proto::trace::v1::ResourceSpans *
ExportTraceServiceRequest::add_resource_spans() ABSL_ATTRIBUTE_LIFETIME_BOUND {
	::google::protobuf::internal::TSanWrite(&_impl_);
...
ExportTraceServiceRequest::resource_spans() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline const ::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess &
ExportTraceServiceResponse::_internal_partial_success() const {
	::google::protobuf::internal::TSanRead(&_impl_);
	const ::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess *p = _impl_.partial_success_;
	return p != nullptr
	           ? *p
	           : reinterpret_cast<const ::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess &>(
	                 ::opentelemetry::proto::collector::trace::v1::_ExportTracePartialSuccess_default_instance_);
}
inline const ::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess &
ExportTraceServiceResponse::partial_success() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void ExportTraceServiceResponse::unsafe_arena_set_allocated_partial_success(
	...
	_impl_.partial_success_ =
	    reinterpret_cast<::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess *>(value);
	if (value != nullptr) {
		_impl_._has_bits_[0] |= 0x00000001u;
	} else {
		_impl_._has_bits_[0] &= ~0x00000001u;
...
inline ::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess *
ExportTraceServiceResponse::release_partial_success() {
	::google::protobuf::internal::TSanWrite(&_impl_);
...
ExportTraceServiceResponse::_internal_mutable_partial_success() {
	...
	if (_impl_.partial_success_ == nullptr) {
		auto *p = ::google::protobuf::Message::DefaultConstruct<
		    ::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess>(GetArena());
		_impl_.partial_success_ =
		    reinterpret_cast<::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess *>(p);
	}
	return _impl_.partial_success_;
}
inline ::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess *
ExportTraceServiceResponse::mutable_partial_success() ABSL_ATTRIBUTE_LIFETIME_BOUND {
	_impl_._has_bits_[0] |= 0x00000001u;
...
inline void ExportTraceServiceResponse::set_allocated_partial_success(
    ::opentelemetry::proto::collector::trace::v1::ExportTracePartialSuccess *value) {
...
inline const std::string &ExportTracePartialSuccess::error_message() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline PROTOBUF_ALWAYS_INLINE void ExportTracePartialSuccess::set_error_message(Arg_ &&arg, Args_... args) {
	::google::protobuf::internal::TSanWrite(&_impl_);
