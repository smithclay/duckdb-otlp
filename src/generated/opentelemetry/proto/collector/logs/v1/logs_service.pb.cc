...
inline constexpr ExportLogsPartialSuccess::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : error_message_(&::google::protobuf::internal::fixed_address_empty_string, ::_pbi::ConstantInitialized()),
      rejected_log_records_ {::int64_t {0}}, _cached_size_ {0} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    ExportLogsPartialSuccessDefaultTypeInternal _ExportLogsPartialSuccess_default_instance_;

inline constexpr ExportLogsServiceResponse::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    ExportLogsServiceResponseDefaultTypeInternal _ExportLogsServiceResponse_default_instance_;

inline constexpr ExportLogsServiceRequest::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : resource_logs_ {}, _cached_size_ {0} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    ExportLogsServiceRequestDefaultTypeInternal _ExportLogsServiceRequest_default_instance_;
} // namespace v1
} // namespace logs
} // namespace collector
} // namespace proto
...
const ::uint32_t TableStruct_opentelemetry_2fproto_2fcollector_2flogs_2fv1_2flogs_5fservice_2eproto::offsets
    [] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
        ~0u, // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::collector::logs::v1::ExportLogsServiceRequest,
                              _internal_metadata_),
        ~0u, // no _extensions_
        ~0u, // no _oneof_case_
        ...
        ~0u, // no sizeof(Split)
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::collector::logs::v1::ExportLogsServiceRequest,
                              _impl_.resource_logs_),
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::collector::logs::v1::ExportLogsServiceResponse,
                              _impl_._has_bits_),
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::collector::logs::v1::ExportLogsServiceResponse,
                              _internal_metadata_),
        ~0u, // no _extensions_
        ...
        0,
        ~0u, // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::collector::logs::v1::ExportLogsPartialSuccess,
                              _internal_metadata_),
        ~0u, // no _extensions_
        ~0u, // no _oneof_case_
        ~0u, // no _weak_field_map_
...
const char descriptor_table_protodef_opentelemetry_2fproto_2fcollector_2flogs_2fv1_2flogs_5fservice_2eproto
    [] ABSL_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
...
static const ::_pbi::DescriptorTable
    *const descriptor_table_opentelemetry_2fproto_2fcollector_2flogs_2fv1_2flogs_5fservice_2eproto_deps[1] = {
...
ExportLogsServiceRequest::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
...
inline void *ExportLogsServiceRequest::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
constexpr auto ExportLogsServiceRequest::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(ExportLogsServiceRequest, _impl_.resource_logs_) +
	        decltype(ExportLogsServiceRequest::_impl_.resource_logs_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(ExportLogsServiceRequest),
		                                                              alignof(ExportLogsServiceRequest), *arena_bits);
	} else {
...
const ::google::protobuf::internal::ClassDataFull ExportLogsServiceRequest::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<ExportLogsServiceRequest>(),
        &ExportLogsServiceRequest::ByteSizeLong,
    ...
    ExportLogsServiceRequest::_table_ = {
        {
            ...
            ::_pbi::TcParser::GetTable<
                ::opentelemetry::proto::collector::logs::v1::ExportLogsServiceRequest>(), // to_prefetch
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *ExportLogsServiceRequest::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                                        ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const ExportLogsServiceRequest &this_ = static_cast<const ExportLogsServiceRequest &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *ExportLogsServiceRequest::_InternalSerialize(::uint8_t *target,
...
public:
	...
	static constexpr ::int32_t kHasBitsOffset = 8 * PROTOBUF_FIELD_OFFSET(ExportLogsServiceResponse, _impl_._has_bits_);
};
...
inline PROTOBUF_NDEBUG_INLINE
ExportLogsServiceResponse::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                        ::google::protobuf::Arena *arena)
    : _cached_size_ {0} {
}
...
inline void *ExportLogsServiceResponse::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
const ::google::protobuf::internal::ClassDataFull ExportLogsServiceResponse::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<ExportLogsServiceResponse>(),
        &ExportLogsServiceResponse::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 1, 1, 0, 2>
    ExportLogsServiceResponse::_table_ = {
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::opentelemetry::proto::collector::logs::v1::ExportLogsServiceResponse>(), // to_prefetch
#endif // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
        ...
        {{
            // .opentelemetry.proto.collector.logs.v1.ExportLogsPartialSuccess partial_success = 1;
            {PROTOBUF_FIELD_OFFSET(ExportLogsServiceResponse, _impl_.partial_success_), _Internal::kHasBitsOffset + 0,
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *ExportLogsServiceResponse::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                                         ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const ExportLogsServiceResponse &this_ = static_cast<const ExportLogsServiceResponse &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *ExportLogsServiceResponse::_InternalSerialize(::uint8_t *target,
                                                         ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	if (cached_has_bits & 0x00000001u) {
		...
		if (_this->_impl_.partial_success_ == nullptr) {
			_this->_impl_.partial_success_ = ::google::protobuf::Message::CopyConstruct<
			    ::opentelemetry::proto::collector::logs::v1::ExportLogsPartialSuccess>(arena,
...
inline PROTOBUF_NDEBUG_INLINE
ExportLogsPartialSuccess::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                       ::google::protobuf::Arena *arena)
...
inline void *ExportLogsPartialSuccess::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
const ::google::protobuf::internal::ClassDataFull ExportLogsPartialSuccess::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<ExportLogsPartialSuccess>(),
        &ExportLogsPartialSuccess::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<1, 2, 0, 84, 2>
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::opentelemetry::proto::collector::logs::v1::ExportLogsPartialSuccess>(), // to_prefetch
#endif // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
            ...
            {::_pbi::TcParser::SingularVarintNoZag1<
                 ::uint64_t, offsetof(ExportLogsPartialSuccess, _impl_.rejected_log_records_), 63>(),
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *ExportLogsPartialSuccess::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                                        ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const ExportLogsPartialSuccess &this_ = static_cast<const ExportLogsPartialSuccess &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *ExportLogsPartialSuccess::_InternalSerialize(::uint8_t *target,
                                                        ::google::protobuf::io::EpsCopyOutputStream *stream) const {
...
::size_t ExportLogsPartialSuccess::ByteSizeLong() const {
	...
	::_pbi::Prefetch5LinesFrom7Lines(&this_);
	{
		...
		// int64 rejected_log_records = 1;
		if (this_._internal_rejected_log_records() != 0) {
			total_size += ::_pbi::WireFormatLite::Int64SizePlusOne(this_._internal_rejected_log_records());
		}
	}
	return this_.MaybeComputeUnknownFieldsSize(total_size, &this_._impl_._cached_size_);
}
