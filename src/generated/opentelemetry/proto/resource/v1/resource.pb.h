...
protected:
	...
	Resource(::google::protobuf::Arena *arena, Resource &&from) noexcept : Resource(arena) {
		*this = ::std::move(from);
	}
...
private:
	...
	struct Impl_ {
		...
		inline explicit Impl_(::google::protobuf::internal::InternalVisibility visibility,
		                      ::google::protobuf::Arena *arena, const Impl_ &from, const Resource &from_msg);
...
Resource::mutable_attributes(int index) ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
Resource::attributes(int index) const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
Resource::attributes() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
