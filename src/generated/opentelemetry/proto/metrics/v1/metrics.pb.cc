...
inline constexpr SummaryDataPoint_ValueAtQuantile::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : quantile_ {0}, value_ {0}, _cached_size_ {0} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    SummaryDataPoint_ValueAtQuantileDefaultTypeInternal _SummaryDataPoint_ValueAtQuantile_default_instance_;

inline constexpr ExponentialHistogramDataPoint_Buckets::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : bucket_counts_ {}, _bucket_counts_cached_byte_size_ {0}, offset_ {0}, _cached_size_ {0} {
}

template <typename>
PROTOBUF_CONSTEXPR
ExponentialHistogramDataPoint_Buckets::ExponentialHistogramDataPoint_Buckets(::_pbi::ConstantInitialized)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(_class_data_.base()),
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(),
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    ExponentialHistogramDataPoint_BucketsDefaultTypeInternal _ExponentialHistogramDataPoint_Buckets_default_instance_;

inline constexpr SummaryDataPoint::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : quantile_values_ {}, attributes_ {}, start_time_unix_nano_ {::uint64_t {0u}},
      time_unix_nano_ {::uint64_t {0u}}, count_ {::uint64_t {0u}}, sum_ {0}, flags_ {0u}, _cached_size_ {0} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SummaryDataPointDefaultTypeInternal
    _SummaryDataPoint_default_instance_;

inline constexpr Exemplar::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : filtered_attributes_ {},
      ...
      time_unix_nano_ {::uint64_t {0u}}, value_ {}, _cached_size_ {0}, _oneof_case_ {} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ExemplarDefaultTypeInternal
    _Exemplar_default_instance_;

inline constexpr Summary::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept : data_points_ {}, _cached_size_ {0} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SummaryDefaultTypeInternal
    _Summary_default_instance_;

inline constexpr NumberDataPoint::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : exemplars_ {}, attributes_ {}, start_time_unix_nano_ {::uint64_t {0u}},
      time_unix_nano_ {::uint64_t {0u}}, flags_ {0u}, value_ {}, _cached_size_ {0}, _oneof_case_ {} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 NumberDataPointDefaultTypeInternal
    _NumberDataPoint_default_instance_;

inline constexpr HistogramDataPoint::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : _cached_size_ {0}, bucket_counts_ {}, explicit_bounds_ {}, exemplars_ {}, attributes_ {},
      start_time_unix_nano_ {::uint64_t {0u}},
      time_unix_nano_ {::uint64_t {0u}}, count_ {::uint64_t {0u}}, sum_ {0}, min_ {0}, max_ {0}, flags_ {0u} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 HistogramDataPointDefaultTypeInternal
    _HistogramDataPoint_default_instance_;

inline constexpr ExponentialHistogramDataPoint::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : _cached_size_ {0}, attributes_ {}, exemplars_ {}, positive_ {nullptr}, negative_ {nullptr},
      start_time_unix_nano_ {::uint64_t {0u}}, time_unix_nano_ {::uint64_t {0u}}, count_ {::uint64_t {0u}}, sum_ {0},
      zero_count_ {::uint64_t {0u}}, scale_ {0}, flags_ {0u}, min_ {0}, max_ {0}, zero_threshold_ {0} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    ExponentialHistogramDataPointDefaultTypeInternal _ExponentialHistogramDataPoint_default_instance_;

inline constexpr Sum::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : data_points_ {},
      aggregation_temporality_ {static_cast<::opentelemetry::proto::metrics::v1::AggregationTemporality>(0)},
      is_monotonic_ {false}, _cached_size_ {0} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 SumDefaultTypeInternal
    _Sum_default_instance_;

inline constexpr Histogram::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : data_points_ {},
      aggregation_temporality_ {static_cast<::opentelemetry::proto::metrics::v1::AggregationTemporality>(0)},
      _cached_size_ {0} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 HistogramDefaultTypeInternal
    _Histogram_default_instance_;

inline constexpr Gauge::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept : data_points_ {}, _cached_size_ {0} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 GaugeDefaultTypeInternal
    _Gauge_default_instance_;

inline constexpr ExponentialHistogram::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : data_points_ {},
      aggregation_temporality_ {static_cast<::opentelemetry::proto::metrics::v1::AggregationTemporality>(0)},
      _cached_size_ {0} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    ExponentialHistogramDefaultTypeInternal _ExponentialHistogram_default_instance_;

inline constexpr Metric::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : name_(&::google::protobuf::internal::fixed_address_empty_string, ::_pbi::ConstantInitialized()),
      description_(&::google::protobuf::internal::fixed_address_empty_string, ::_pbi::ConstantInitialized()),
      unit_(&::google::protobuf::internal::fixed_address_empty_string, ::_pbi::ConstantInitialized()), data_ {},
      _cached_size_ {0}, _oneof_case_ {} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 MetricDefaultTypeInternal
    _Metric_default_instance_;

inline constexpr ScopeMetrics::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : _cached_size_ {0}, metrics_ {},
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ScopeMetricsDefaultTypeInternal
    _ScopeMetrics_default_instance_;

inline constexpr ResourceMetrics::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : _cached_size_ {0}, scope_metrics_ {},
      schema_url_(&::google::protobuf::internal::fixed_address_empty_string, ::_pbi::ConstantInitialized()),
      resource_ {nullptr} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ResourceMetricsDefaultTypeInternal
    _ResourceMetrics_default_instance_;

inline constexpr MetricsData::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : resource_metrics_ {}, _cached_size_ {0} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 MetricsDataDefaultTypeInternal
...
const ::uint32_t
    TableStruct_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::metrics::v1::ExponentialHistogram,
        ...
        2,
        ~0u, // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::metrics::v1::ExponentialHistogramDataPoint_Buckets,
                              _internal_metadata_),
        ~0u, // no _extensions_
        ~0u, // no _oneof_case_
        ~0u, // no _weak_field_map_
        ...
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::metrics::v1::ExponentialHistogramDataPoint,
                              _impl_.start_time_unix_nano_),
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::metrics::v1::ExponentialHistogramDataPoint,
        ...
        ~0u,
        ~0u, // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::metrics::v1::SummaryDataPoint_ValueAtQuantile,
                              _internal_metadata_),
        ~0u, // no _extensions_
        ~0u, // no _oneof_case_
        ~0u, // no _weak_field_map_
...
const char
    descriptor_table_protodef_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        protodesc_cold) = {
...
static const ::_pbi::DescriptorTable
    *const descriptor_table_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto_deps[2] = {
...
MetricsData::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility, ::google::protobuf::Arena *arena,
                          const Impl_ &from, const ::opentelemetry::proto::metrics::v1::MetricsData &from_msg)
    : resource_metrics_ {visibility, arena, from.resource_metrics_}, _cached_size_ {0} {
}

MetricsData::MetricsData(::google::protobuf::Arena *arena, const MetricsData &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
inline PROTOBUF_NDEBUG_INLINE MetricsData::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                        ::google::protobuf::Arena *arena)
    : resource_metrics_ {visibility, arena}, _cached_size_ {0} {
}
...
inline void *MetricsData::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
constexpr auto MetricsData::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(MetricsData, _impl_.resource_metrics_) +
	        decltype(MetricsData::_impl_.resource_metrics_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(MetricsData), alignof(MetricsData),
		                                                              *arena_bits);
	} else {
		return ::google::protobuf::internal::MessageCreator(&MetricsData::PlacementNew_, sizeof(MetricsData),
		                                                    alignof(MetricsData));
	}
}
PROTOBUF_CONSTINIT
...
const ::google::protobuf::internal::ClassDataFull MetricsData::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<MetricsData>(),
        &MetricsData::ByteSizeLong,
        &MetricsData::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(MetricsData, _impl_._cached_size_),
        false,
    },
    &MetricsData::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 1, 1, 0, 2> MetricsData::_table_ = {
    {
        0,    // no _has_bits_
        0,    // no _extensions_
    ...
    {{
        ...
        {::_pbi::TcParser::FastMtR1, {10, 63, 0, PROTOBUF_FIELD_OFFSET(MetricsData, _impl_.resource_metrics_)}},
    }},
    {{65535, 65535}},
    {{
        // repeated .opentelemetry.proto.metrics.v1.ResourceMetrics resource_metrics = 1;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *MetricsData::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                           ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const MetricsData &this_ = static_cast<const MetricsData &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *MetricsData::_InternalSerialize(::uint8_t *target,
	...
	// repeated .opentelemetry.proto.metrics.v1.ResourceMetrics resource_metrics = 1;
	for (unsigned i = 0, n = static_cast<unsigned>(this_._internal_resource_metrics_size()); i < n; i++) {
...
public:
	...
	static constexpr ::int32_t kHasBitsOffset = 8 * PROTOBUF_FIELD_OFFSET(ResourceMetrics, _impl_._has_bits_);
};
...
inline PROTOBUF_NDEBUG_INLINE
ResourceMetrics::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                              ::google::protobuf::Arena *arena, const Impl_ &from,
                              const ::opentelemetry::proto::metrics::v1::ResourceMetrics &from_msg)
    : _has_bits_ {from._has_bits_}, _cached_size_ {0}, scope_metrics_ {visibility, arena, from.scope_metrics_},
      schema_url_(arena, from.schema_url_) {
}

ResourceMetrics::ResourceMetrics(::google::protobuf::Arena *arena, const ResourceMetrics &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
inline PROTOBUF_NDEBUG_INLINE ResourceMetrics::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                            ::google::protobuf::Arena *arena)
    : _cached_size_ {0}, scope_metrics_ {visibility, arena}, schema_url_(arena) {
}
...
inline void *ResourceMetrics::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
constexpr auto ResourceMetrics::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(ResourceMetrics, _impl_.scope_metrics_) +
	        decltype(ResourceMetrics::_impl_.scope_metrics_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(ResourceMetrics), alignof(ResourceMetrics),
		                                                              *arena_bits);
	} else {
		return ::google::protobuf::internal::MessageCreator(&ResourceMetrics::PlacementNew_, sizeof(ResourceMetrics),
...
const ::google::protobuf::internal::ClassDataFull ResourceMetrics::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<ResourceMetrics>(),
        &ResourceMetrics::ByteSizeLong,
        &ResourceMetrics::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(ResourceMetrics, _impl_._cached_size_),
        false,
    },
    &ResourceMetrics::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<2, 3, 2, 65, 2>
    ResourceMetrics::_table_ = {
        ...
        {{
            ...
            {::_pbi::TcParser::FastMtS1, {10, 0, 0, PROTOBUF_FIELD_OFFSET(ResourceMetrics, _impl_.resource_)}},
            // repeated .opentelemetry.proto.metrics.v1.ScopeMetrics scope_metrics = 2;
            {::_pbi::TcParser::FastMtR1, {18, 63, 1, PROTOBUF_FIELD_OFFSET(ResourceMetrics, _impl_.scope_metrics_)}},
            // string schema_url = 3;
            {::_pbi::TcParser::FastUS1, {26, 63, 0, PROTOBUF_FIELD_OFFSET(ResourceMetrics, _impl_.schema_url_)}},
        }},
        {{65535, 65535}},
        {{
            // .opentelemetry.proto.resource.v1.Resource resource = 1;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *ResourceMetrics::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                               ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const ResourceMetrics &this_ = static_cast<const ResourceMetrics &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *ResourceMetrics::_InternalSerialize(::uint8_t *target,
                                               ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	// repeated .opentelemetry.proto.metrics.v1.ScopeMetrics scope_metrics = 2;
	for (unsigned i = 0, n = static_cast<unsigned>(this_._internal_scope_metrics_size()); i < n; i++) {
...
public:
	...
	static constexpr ::int32_t kHasBitsOffset = 8 * PROTOBUF_FIELD_OFFSET(ScopeMetrics, _impl_._has_bits_);
};
...
inline PROTOBUF_NDEBUG_INLINE
ScopeMetrics::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                           ::google::protobuf::Arena *arena, const Impl_ &from,
                           const ::opentelemetry::proto::metrics::v1::ScopeMetrics &from_msg)
    : _has_bits_ {from._has_bits_}, _cached_size_ {0}, metrics_ {visibility, arena, from.metrics_},
      schema_url_(arena, from.schema_url_) {
}

ScopeMetrics::ScopeMetrics(::google::protobuf::Arena *arena, const ScopeMetrics &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
inline PROTOBUF_NDEBUG_INLINE ScopeMetrics::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                         ::google::protobuf::Arena *arena)
    : _cached_size_ {0}, metrics_ {visibility, arena}, schema_url_(arena) {
}
...
inline void *ScopeMetrics::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
constexpr auto ScopeMetrics::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(ScopeMetrics, _impl_.metrics_) +
	        decltype(ScopeMetrics::_impl_.metrics_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(ScopeMetrics), alignof(ScopeMetrics),
		                                                              *arena_bits);
	} else {
		return ::google::protobuf::internal::MessageCreator(&ScopeMetrics::PlacementNew_, sizeof(ScopeMetrics),
...
const ::google::protobuf::internal::ClassDataFull ScopeMetrics::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<ScopeMetrics>(),
        &ScopeMetrics::ByteSizeLong,
        &ScopeMetrics::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(ScopeMetrics, _impl_._cached_size_),
        false,
    },
    &ScopeMetrics::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<2, 3, 2, 62, 2> ScopeMetrics::_table_ =
    {
        {
        ...
        {{
            ...
            {::_pbi::TcParser::FastMtS1, {10, 0, 0, PROTOBUF_FIELD_OFFSET(ScopeMetrics, _impl_.scope_)}},
            // repeated .opentelemetry.proto.metrics.v1.Metric metrics = 2;
            {::_pbi::TcParser::FastMtR1, {18, 63, 1, PROTOBUF_FIELD_OFFSET(ScopeMetrics, _impl_.metrics_)}},
            // string schema_url = 3;
            {::_pbi::TcParser::FastUS1, {26, 63, 0, PROTOBUF_FIELD_OFFSET(ScopeMetrics, _impl_.schema_url_)}},
        }},
        {{65535, 65535}},
        {{
            // .opentelemetry.proto.common.v1.InstrumentationScope scope = 1;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *ScopeMetrics::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                            ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const ScopeMetrics &this_ = static_cast<const ScopeMetrics &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *ScopeMetrics::_InternalSerialize(::uint8_t *target,
                                            ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	// repeated .opentelemetry.proto.metrics.v1.Metric metrics = 2;
	for (unsigned i = 0, n = static_cast<unsigned>(this_._internal_metrics_size()); i < n; i++) {
...
void Metric::set_allocated_exponential_histogram(
	...
	if (exponential_histogram) {
		...
		if (message_arena != submessage_arena) {
			exponential_histogram =
			    ::google::protobuf::internal::GetOwnedMessage(message_arena, exponential_histogram, submessage_arena);
		}
...
inline PROTOBUF_NDEBUG_INLINE Metric::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                   ::google::protobuf::Arena *arena, const Impl_ &from,
                                                   const ::opentelemetry::proto::metrics::v1::Metric &from_msg)
    : name_(arena, from.name_), description_(arena, from.description_),
      unit_(arena, from.unit_), data_ {}, _cached_size_ {0}, _oneof_case_ {from._oneof_case_[0]} {
}

Metric::Metric(::google::protobuf::Arena *arena, const Metric &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
	...
	case DATA_NOT_SET:
		break;
	case kGauge:
		_impl_.data_.gauge_ = ::google::protobuf::Message::CopyConstruct<::opentelemetry::proto::metrics::v1::Gauge>(
		    arena, *from._impl_.data_.gauge_);
		break;
	case kSum:
		_impl_.data_.sum_ = ::google::protobuf::Message::CopyConstruct<::opentelemetry::proto::metrics::v1::Sum>(
		    arena, *from._impl_.data_.sum_);
		break;
	case kHistogram:
		_impl_.data_.histogram_ =
		    ::google::protobuf::Message::CopyConstruct<::opentelemetry::proto::metrics::v1::Histogram>(
		        arena, *from._impl_.data_.histogram_);
		break;
	case kExponentialHistogram:
		_impl_.data_.exponential_histogram_ =
		    ::google::protobuf::Message::CopyConstruct<::opentelemetry::proto::metrics::v1::ExponentialHistogram>(
		        arena, *from._impl_.data_.exponential_histogram_);
		break;
	case kSummary:
		_impl_.data_.summary_ =
		    ::google::protobuf::Message::CopyConstruct<::opentelemetry::proto::metrics::v1::Summary>(
		        arena, *from._impl_.data_.summary_);
		break;
	}
...
inline PROTOBUF_NDEBUG_INLINE Metric::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                   ::google::protobuf::Arena *arena)
    : name_(arena), description_(arena), unit_(arena), data_ {}, _cached_size_ {0}, _oneof_case_ {} {
}
...
inline void *Metric::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
	return ::new (mem) Metric(arena);
}
constexpr auto Metric::InternalNewImpl_() {
	return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(Metric), alignof(Metric));
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull Metric::_class_data_ = {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &Metric::SharedDtor,
        ::google::protobuf::Message::GetClearImpl<Metric>(),
        &Metric::ByteSizeLong,
    ...
    &Metric::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<2, 8, 5, 73, 2> Metric::_table_ = {
    {
        0,      // no _has_bits_
        0,      // no _extensions_
    ...
    {{
        {::_pbi::TcParser::MiniParse, {}},
        // string name = 1;
        {::_pbi::TcParser::FastUS1, {10, 63, 0, PROTOBUF_FIELD_OFFSET(Metric, _impl_.name_)}},
        // string description = 2;
        {::_pbi::TcParser::FastUS1, {18, 63, 0, PROTOBUF_FIELD_OFFSET(Metric, _impl_.description_)}},
        // string unit = 3;
        {::_pbi::TcParser::FastUS1, {26, 63, 0, PROTOBUF_FIELD_OFFSET(Metric, _impl_.unit_)}},
    }},
    {{65535, 65535}},
    {{
        // string name = 1;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *Metric::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                      ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const Metric &this_ = static_cast<const Metric &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *Metric::_InternalSerialize(::uint8_t *target, ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	case kGauge: {
		target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
		    5, *this_._impl_.data_.gauge_, this_._impl_.data_.gauge_->GetCachedSize(), target, stream);
		break;
	}
	case kSum: {
		target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
		    7, *this_._impl_.data_.sum_, this_._impl_.data_.sum_->GetCachedSize(), target, stream);
		break;
	}
	case kHistogram: {
		target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
		    9, *this_._impl_.data_.histogram_, this_._impl_.data_.histogram_->GetCachedSize(), target, stream);
		break;
	}
	case kExponentialHistogram: {
		target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
		    10, *this_._impl_.data_.exponential_histogram_, this_._impl_.data_.exponential_histogram_->GetCachedSize(),
		    target, stream);
		break;
	}
	case kSummary: {
		target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
		    11, *this_._impl_.data_.summary_, this_._impl_.data_.summary_->GetCachedSize(), target, stream);
		break;
	}
	default:
		break;
...
::size_t Metric::ByteSizeLong() const {
	...
	::_pbi::Prefetch5LinesFrom7Lines(&this_);
	{
		...
		// string description = 2;
		if (!this_._internal_description().empty()) {
			total_size += 1 + ::google::protobuf::internal::WireFormatLite::StringSize(this_._internal_description());
		}
		// string unit = 3;
		if (!this_._internal_unit().empty()) {
			total_size += 1 + ::google::protobuf::internal::WireFormatLite::StringSize(this_._internal_unit());
		}
	}
	switch (this_.data_case()) {
	// .opentelemetry.proto.metrics.v1.Gauge gauge = 5;
	case kGauge: {
		total_size += 1 + ::google::protobuf::internal::WireFormatLite::MessageSize(*this_._impl_.data_.gauge_);
		break;
	}
	// .opentelemetry.proto.metrics.v1.Sum sum = 7;
	case kSum: {
		total_size += 1 + ::google::protobuf::internal::WireFormatLite::MessageSize(*this_._impl_.data_.sum_);
		break;
	}
	// .opentelemetry.proto.metrics.v1.Histogram histogram = 9;
	case kHistogram: {
		total_size += 1 + ::google::protobuf::internal::WireFormatLite::MessageSize(*this_._impl_.data_.histogram_);
		break;
	}
	// .opentelemetry.proto.metrics.v1.ExponentialHistogram exponential_histogram = 10;
	case kExponentialHistogram: {
		total_size +=
		    1 + ::google::protobuf::internal::WireFormatLite::MessageSize(*this_._impl_.data_.exponential_histogram_);
		break;
	}
	// .opentelemetry.proto.metrics.v1.Summary summary = 11;
	case kSummary: {
		total_size += 1 + ::google::protobuf::internal::WireFormatLite::MessageSize(*this_._impl_.data_.summary_);
		break;
	}
	case DATA_NOT_SET: {
		break;
...
void Metric::MergeImpl(::google::protobuf::MessageLite &to_msg, const ::google::protobuf::MessageLite &from_msg) {
	...
	if (const uint32_t oneof_from_case = from._impl_._oneof_case_[0]) {
		...
		case kGauge: {
			if (oneof_needs_init) {
				_this->_impl_.data_.gauge_ =
				    ::google::protobuf::Message::CopyConstruct<::opentelemetry::proto::metrics::v1::Gauge>(
				        arena, *from._impl_.data_.gauge_);
			} else {
		...
		case kSum: {
			if (oneof_needs_init) {
				_this->_impl_.data_.sum_ =
				    ::google::protobuf::Message::CopyConstruct<::opentelemetry::proto::metrics::v1::Sum>(
				        arena, *from._impl_.data_.sum_);
			} else {
		...
		case kExponentialHistogram: {
			if (oneof_needs_init) {
				_this->_impl_.data_.exponential_histogram_ = ::google::protobuf::Message::CopyConstruct<
...
inline PROTOBUF_NDEBUG_INLINE Gauge::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                  ::google::protobuf::Arena *arena, const Impl_ &from,
                                                  const ::opentelemetry::proto::metrics::v1::Gauge &from_msg)
    : data_points_ {visibility, arena, from.data_points_}, _cached_size_ {0} {
}

Gauge::Gauge(::google::protobuf::Arena *arena, const Gauge &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
inline PROTOBUF_NDEBUG_INLINE Gauge::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                  ::google::protobuf::Arena *arena)
    : data_points_ {visibility, arena}, _cached_size_ {0} {
}
...
inline void *Gauge::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
	return ::new (mem) Gauge(arena);
}
constexpr auto Gauge::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(Gauge, _impl_.data_points_) +
	        decltype(Gauge::_impl_.data_points_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(Gauge), alignof(Gauge), *arena_bits);
	} else {
		return ::google::protobuf::internal::MessageCreator(&Gauge::PlacementNew_, sizeof(Gauge), alignof(Gauge));
	}
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull Gauge::_class_data_ = {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &Gauge::SharedDtor,
        ::google::protobuf::Message::GetClearImpl<Gauge>(),
        &Gauge::ByteSizeLong,
    ...
    &Gauge::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 1, 1, 0, 2> Gauge::_table_ = {
    {
        0,    // no _has_bits_
        0,    // no _extensions_
        1, 0, // max_field_number, fast_idx_mask
    ...
    {{
        ...
        {::_pbi::TcParser::FastMtR1, {10, 63, 0, PROTOBUF_FIELD_OFFSET(Gauge, _impl_.data_points_)}},
    }},
    {{65535, 65535}},
    {{
        // repeated .opentelemetry.proto.metrics.v1.NumberDataPoint data_points = 1;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *Gauge::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                     ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const Gauge &this_ = static_cast<const Gauge &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *Gauge::_InternalSerialize(::uint8_t *target, ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	// repeated .opentelemetry.proto.metrics.v1.NumberDataPoint data_points = 1;
	for (unsigned i = 0, n = static_cast<unsigned>(this_._internal_data_points_size()); i < n; i++) {
...
inline PROTOBUF_NDEBUG_INLINE Sum::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                ::google::protobuf::Arena *arena, const Impl_ &from,
                                                const ::opentelemetry::proto::metrics::v1::Sum &from_msg)
    : data_points_ {visibility, arena, from.data_points_}, _cached_size_ {0} {
}

Sum::Sum(::google::protobuf::Arena *arena, const Sum &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
	...
	_internal_metadata_.MergeFrom<::google::protobuf::UnknownFieldSet>(from._internal_metadata_);
	new (&_impl_) Impl_(internal_visibility(), arena, from._impl_, from);
	::memcpy(reinterpret_cast<char *>(&_impl_) + offsetof(Impl_, aggregation_temporality_),
	         reinterpret_cast<const char *>(&from._impl_) + offsetof(Impl_, aggregation_temporality_),
	         offsetof(Impl_, is_monotonic_) - offsetof(Impl_, aggregation_temporality_) + sizeof(Impl_::is_monotonic_));
...
inline void Sum::SharedCtor(::_pb::Arena *arena) {
	new (&_impl_) Impl_(internal_visibility(), arena);
	::memset(reinterpret_cast<char *>(&_impl_) + offsetof(Impl_, aggregation_temporality_), 0,
	         offsetof(Impl_, is_monotonic_) - offsetof(Impl_, aggregation_temporality_) + sizeof(Impl_::is_monotonic_));
}
Sum::~Sum() {
...
inline void *Sum::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
	return ::new (mem) Sum(arena);
}
constexpr auto Sum::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(Sum, _impl_.data_points_) + decltype(Sum::_impl_.data_points_)::InternalGetArenaOffset(
	                                                          ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(Sum), alignof(Sum), *arena_bits);
	} else {
		return ::google::protobuf::internal::MessageCreator(&Sum::PlacementNew_, sizeof(Sum), alignof(Sum));
	}
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull Sum::_class_data_ = {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &Sum::SharedDtor,
        ::google::protobuf::Message::GetClearImpl<Sum>(),
        &Sum::ByteSizeLong,
    ...
    &Sum::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<2, 3, 1, 0, 2> Sum::_table_ = {
    {
        0,     // no _has_bits_
        0,     // no _extensions_
        3, 24, // max_field_number, fast_idx_mask
    ...
    {{
        {::_pbi::TcParser::MiniParse, {}},
        // repeated .opentelemetry.proto.metrics.v1.NumberDataPoint data_points = 1;
        {::_pbi::TcParser::FastMtR1, {10, 63, 0, PROTOBUF_FIELD_OFFSET(Sum, _impl_.data_points_)}},
    ...
    {{
        ...
        // bool is_monotonic = 3;
        {PROTOBUF_FIELD_OFFSET(Sum, _impl_.is_monotonic_), 0, 0, (0 | ::_fl::kFcSingular | ::_fl::kBool)},
    }},
    {{
        {::_pbi::TcParser::GetTable<::opentelemetry::proto::metrics::v1::NumberDataPoint>()},
    }},
...
PROTOBUF_NOINLINE void Sum::Clear() {
	...
	_impl_.data_points_.Clear();
	::memset(&_impl_.aggregation_temporality_, 0,
	         static_cast<::size_t>(reinterpret_cast<char *>(&_impl_.is_monotonic_) -
	                               reinterpret_cast<char *>(&_impl_.aggregation_temporality_)) +
	             sizeof(_impl_.is_monotonic_));
	_internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
}

#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *Sum::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                   ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const Sum &this_ = static_cast<const Sum &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *Sum::_InternalSerialize(::uint8_t *target, ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	if (this_._internal_aggregation_temporality() != 0) {
		...
		target = ::_pbi::WireFormatLite::WriteEnumToArray(2, this_._internal_aggregation_temporality(), target);
	}

	// bool is_monotonic = 3;
	if (this_._internal_is_monotonic() != 0) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteBoolToArray(3, this_._internal_is_monotonic(), target);
	}
...
}
{
	// .opentelemetry.proto.metrics.v1.AggregationTemporality aggregation_temporality = 2;
	if (this_._internal_aggregation_temporality() != 0) {
		total_size += 1 + ::_pbi::WireFormatLite::EnumSize(this_._internal_aggregation_temporality());
	}
	// bool is_monotonic = 3;
	if (this_._internal_is_monotonic() != 0) {
		total_size += 2;
...
void Sum::InternalSwap(Sum *PROTOBUF_RESTRICT other) {
	...
	_internal_metadata_.InternalSwap(&other->_internal_metadata_);
	_impl_.data_points_.InternalSwap(&other->_impl_.data_points_);
	::google::protobuf::internal::memswap<PROTOBUF_FIELD_OFFSET(Sum, _impl_.is_monotonic_) +
...
inline PROTOBUF_NDEBUG_INLINE Histogram::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                      ::google::protobuf::Arena *arena, const Impl_ &from,
                                                      const ::opentelemetry::proto::metrics::v1::Histogram &from_msg)
    : data_points_ {visibility, arena, from.data_points_}, _cached_size_ {0} {
}

Histogram::Histogram(::google::protobuf::Arena *arena, const Histogram &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
inline void *Histogram::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
constexpr auto Histogram::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(Histogram, _impl_.data_points_) +
	        decltype(Histogram::_impl_.data_points_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(Histogram), alignof(Histogram),
		                                                              *arena_bits);
	} else {
		return ::google::protobuf::internal::MessageCreator(&Histogram::PlacementNew_, sizeof(Histogram),
		                                                    alignof(Histogram));
	}
}
PROTOBUF_CONSTINIT
...
const ::google::protobuf::internal::ClassDataFull Histogram::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<Histogram>(),
        &Histogram::ByteSizeLong,
        &Histogram::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(Histogram, _impl_._cached_size_),
        false,
    },
    &Histogram::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<1, 2, 1, 0, 2> Histogram::_table_ = {
    {
        0,    // no _has_bits_
        0,    // no _extensions_
    ...
    {{
        ...
        {::_pbi::TcParser::FastMtR1, {10, 63, 0, PROTOBUF_FIELD_OFFSET(Histogram, _impl_.data_points_)}},
    }},
    {{65535, 65535}},
    {{
        // repeated .opentelemetry.proto.metrics.v1.HistogramDataPoint data_points = 1;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *Histogram::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                         ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const Histogram &this_ = static_cast<const Histogram &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *Histogram::_InternalSerialize(::uint8_t *target, ::google::protobuf::io::EpsCopyOutputStream *stream) const {
...
inline PROTOBUF_NDEBUG_INLINE
ExponentialHistogram::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                   ::google::protobuf::Arena *arena, const Impl_ &from,
                                   const ::opentelemetry::proto::metrics::v1::ExponentialHistogram &from_msg)
    : data_points_ {visibility, arena, from.data_points_}, _cached_size_ {0} {
}

ExponentialHistogram::ExponentialHistogram(::google::protobuf::Arena *arena, const ExponentialHistogram &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
inline void *ExponentialHistogram::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
constexpr auto ExponentialHistogram::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(ExponentialHistogram, _impl_.data_points_) +
	        decltype(ExponentialHistogram::_impl_.data_points_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(ExponentialHistogram),
		                                                              alignof(ExponentialHistogram), *arena_bits);
	} else {
		return ::google::protobuf::internal::MessageCreator(
		    &ExponentialHistogram::PlacementNew_, sizeof(ExponentialHistogram), alignof(ExponentialHistogram));
	}
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull ExponentialHistogram::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<ExponentialHistogram>(),
        &ExponentialHistogram::ByteSizeLong,
        &ExponentialHistogram::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(ExponentialHistogram, _impl_._cached_size_),
        false,
    },
    &ExponentialHistogram::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto,
    nullptr, // tracker
};
    ...
    ExponentialHistogram::_table_ = {
        ...
        {{
            ...
            {::_pbi::TcParser::SingularVarintNoZag1<
                 ::uint32_t, offsetof(ExponentialHistogram, _impl_.aggregation_temporality_), 63>(),
            ...
            {::_pbi::TcParser::FastMtR1, {10, 63, 0, PROTOBUF_FIELD_OFFSET(ExponentialHistogram, _impl_.data_points_)}},
        }},
        {{65535, 65535}},
        {{
            // repeated .opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint data_points = 1;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *ExponentialHistogram::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                                    ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const ExponentialHistogram &this_ = static_cast<const ExponentialHistogram &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *ExponentialHistogram::_InternalSerialize(::uint8_t *target,
                                                    ::google::protobuf::io::EpsCopyOutputStream *stream) const {
...
inline PROTOBUF_NDEBUG_INLINE Summary::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                    ::google::protobuf::Arena *arena, const Impl_ &from,
                                                    const ::opentelemetry::proto::metrics::v1::Summary &from_msg)
    : data_points_ {visibility, arena, from.data_points_}, _cached_size_ {0} {
}

Summary::Summary(::google::protobuf::Arena *arena, const Summary &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
inline void *Summary::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
	return ::new (mem) Summary(arena);
}
constexpr auto Summary::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(Summary, _impl_.data_points_) +
	        decltype(Summary::_impl_.data_points_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(Summary), alignof(Summary), *arena_bits);
	} else {
		return ::google::protobuf::internal::MessageCreator(&Summary::PlacementNew_, sizeof(Summary), alignof(Summary));
	}
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &Summary::SharedDtor,
        ::google::protobuf::Message::GetClearImpl<Summary>(),
        &Summary::ByteSizeLong,
        &Summary::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(Summary, _impl_._cached_size_),
        false,
    },
    &Summary::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 1, 1, 0, 2> Summary::_table_ = {
    {
        0,    // no _has_bits_
        0,    // no _extensions_
        1, 0, // max_field_number, fast_idx_mask
    ...
    {{
        ...
        {::_pbi::TcParser::FastMtR1, {10, 63, 0, PROTOBUF_FIELD_OFFSET(Summary, _impl_.data_points_)}},
    }},
    {{65535, 65535}},
    {{
        // repeated .opentelemetry.proto.metrics.v1.SummaryDataPoint data_points = 1;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *Summary::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                       ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const Summary &this_ = static_cast<const Summary &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *Summary::_InternalSerialize(::uint8_t *target, ::google::protobuf::io::EpsCopyOutputStream *stream) const {
...
inline PROTOBUF_NDEBUG_INLINE
NumberDataPoint::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                              ::google::protobuf::Arena *arena, const Impl_ &from,
                              const ::opentelemetry::proto::metrics::v1::NumberDataPoint &from_msg)
    : exemplars_ {visibility, arena, from.exemplars_}, attributes_ {visibility, arena, from.attributes_}, value_ {},
      _cached_size_ {0}, _oneof_case_ {from._oneof_case_[0]} {
}

NumberDataPoint::NumberDataPoint(::google::protobuf::Arena *arena, const NumberDataPoint &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
	...
	_internal_metadata_.MergeFrom<::google::protobuf::UnknownFieldSet>(from._internal_metadata_);
	new (&_impl_) Impl_(internal_visibility(), arena, from._impl_, from);
	::memcpy(reinterpret_cast<char *>(&_impl_) + offsetof(Impl_, start_time_unix_nano_),
	         reinterpret_cast<const char *>(&from._impl_) + offsetof(Impl_, start_time_unix_nano_),
	         offsetof(Impl_, flags_) - offsetof(Impl_, start_time_unix_nano_) + sizeof(Impl_::flags_));
	switch (value_case()) {
	case VALUE_NOT_SET:
		break;
	case kAsDouble:
...
inline PROTOBUF_NDEBUG_INLINE NumberDataPoint::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                            ::google::protobuf::Arena *arena)
    : exemplars_ {visibility, arena}, attributes_ {visibility, arena}, value_ {}, _cached_size_ {0}, _oneof_case_ {} {
}

inline void NumberDataPoint::SharedCtor(::_pb::Arena *arena) {
	new (&_impl_) Impl_(internal_visibility(), arena);
	::memset(reinterpret_cast<char *>(&_impl_) + offsetof(Impl_, start_time_unix_nano_), 0,
	         offsetof(Impl_, flags_) - offsetof(Impl_, start_time_unix_nano_) + sizeof(Impl_::flags_));
}
...
inline void *NumberDataPoint::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
constexpr auto NumberDataPoint::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(NumberDataPoint, _impl_.attributes_) +
	        decltype(NumberDataPoint::_impl_.attributes_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	    PROTOBUF_FIELD_OFFSET(NumberDataPoint, _impl_.exemplars_) +
	        decltype(NumberDataPoint::_impl_.exemplars_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(NumberDataPoint), alignof(NumberDataPoint),
		                                                              *arena_bits);
	} else {
		return ::google::protobuf::internal::MessageCreator(&NumberDataPoint::PlacementNew_, sizeof(NumberDataPoint),
...
const ::google::protobuf::internal::ClassDataFull NumberDataPoint::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<NumberDataPoint>(),
        &NumberDataPoint::ByteSizeLong,
        &NumberDataPoint::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(NumberDataPoint, _impl_._cached_size_),
        false,
    },
    &NumberDataPoint::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<3, 7, 2, 0, 2>
    NumberDataPoint::_table_ = {
        ...
        {{
            ...
            {::_pbi::TcParser::FastF64S1, {25, 63, 0, PROTOBUF_FIELD_OFFSET(NumberDataPoint, _impl_.time_unix_nano_)}},
            {::_pbi::TcParser::MiniParse, {}},
            // repeated .opentelemetry.proto.metrics.v1.Exemplar exemplars = 5;
            {::_pbi::TcParser::FastMtR1, {42, 63, 0, PROTOBUF_FIELD_OFFSET(NumberDataPoint, _impl_.exemplars_)}},
            {::_pbi::TcParser::MiniParse, {}},
            // repeated .opentelemetry.proto.common.v1.KeyValue attributes = 7;
            {::_pbi::TcParser::FastMtR1, {58, 63, 1, PROTOBUF_FIELD_OFFSET(NumberDataPoint, _impl_.attributes_)}},
        }},
        {{65535, 65535}},
        {{
            // fixed64 start_time_unix_nano = 2;
            ...
            {PROTOBUF_FIELD_OFFSET(NumberDataPoint, _impl_.attributes_), 0, 1,
             (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
            // uint32 flags = 8;
            {PROTOBUF_FIELD_OFFSET(NumberDataPoint, _impl_.flags_), 0, 0, (0 | ::_fl::kFcSingular | ::_fl::kUInt32)},
        }},
        {{
...
PROTOBUF_NOINLINE void NumberDataPoint::Clear() {
	...
	_impl_.attributes_.Clear();
	::memset(&_impl_.start_time_unix_nano_, 0,
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *NumberDataPoint::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                               ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const NumberDataPoint &this_ = static_cast<const NumberDataPoint &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *NumberDataPoint::_InternalSerialize(::uint8_t *target,
                                               ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	if (this_._internal_start_time_unix_nano() != 0) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteFixed64ToArray(2, this_._internal_start_time_unix_nano(), target);
	}

	// fixed64 time_unix_nano = 3;
	if (this_._internal_time_unix_nano() != 0) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteFixed64ToArray(3, this_._internal_time_unix_nano(), target);
	}

	// double as_double = 4;
	if (this_.value_case() == kAsDouble) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteDoubleToArray(4, this_._internal_as_double(), target);
	}

	// repeated .opentelemetry.proto.metrics.v1.Exemplar exemplars = 5;
	for (unsigned i = 0, n = static_cast<unsigned>(this_._internal_exemplars_size()); i < n; i++) {
	...
	if (this_.value_case() == kAsInt) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteSFixed64ToArray(6, this_._internal_as_int(), target);
	}
	...
	if (this_._internal_flags() != 0) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteUInt32ToArray(8, this_._internal_flags(), target);
	}
...
void NumberDataPoint::InternalSwap(NumberDataPoint *PROTOBUF_RESTRICT other) {
	...
	::google::protobuf::internal::memswap<PROTOBUF_FIELD_OFFSET(NumberDataPoint, _impl_.flags_) +
...
public:
	...
	static constexpr ::int32_t kHasBitsOffset = 8 * PROTOBUF_FIELD_OFFSET(HistogramDataPoint, _impl_._has_bits_);
};
...
inline PROTOBUF_NDEBUG_INLINE
HistogramDataPoint::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                 ::google::protobuf::Arena *arena, const Impl_ &from,
                                 const ::opentelemetry::proto::metrics::v1::HistogramDataPoint &from_msg)
    : _has_bits_ {from._has_bits_}, _cached_size_ {0}, bucket_counts_ {visibility, arena, from.bucket_counts_},
      explicit_bounds_ {visibility, arena, from.explicit_bounds_}, exemplars_ {visibility, arena, from.exemplars_},
      attributes_ {visibility, arena, from.attributes_} {
}

HistogramDataPoint::HistogramDataPoint(::google::protobuf::Arena *arena, const HistogramDataPoint &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
HistogramDataPoint::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                 ::google::protobuf::Arena *arena)
    : _cached_size_ {0}, bucket_counts_ {visibility, arena}, explicit_bounds_ {visibility, arena},
      exemplars_ {visibility, arena}, attributes_ {visibility, arena} {
}
...
inline void *HistogramDataPoint::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
constexpr auto HistogramDataPoint::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(HistogramDataPoint, _impl_.attributes_) +
	        decltype(HistogramDataPoint::_impl_.attributes_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	    PROTOBUF_FIELD_OFFSET(HistogramDataPoint, _impl_.bucket_counts_) +
	        decltype(HistogramDataPoint::_impl_.bucket_counts_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	    PROTOBUF_FIELD_OFFSET(HistogramDataPoint, _impl_.explicit_bounds_) +
	        decltype(HistogramDataPoint::_impl_.explicit_bounds_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	    PROTOBUF_FIELD_OFFSET(HistogramDataPoint, _impl_.exemplars_) +
	        decltype(HistogramDataPoint::_impl_.exemplars_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(HistogramDataPoint),
		                                                              alignof(HistogramDataPoint), *arena_bits);
	} else {
		return ::google::protobuf::internal::MessageCreator(&HistogramDataPoint::PlacementNew_,
		                                                    sizeof(HistogramDataPoint), alignof(HistogramDataPoint));
	}
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull HistogramDataPoint::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<HistogramDataPoint>(),
        &HistogramDataPoint::ByteSizeLong,
        &HistogramDataPoint::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(HistogramDataPoint, _impl_._cached_size_),
        false,
    },
    &HistogramDataPoint::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<4, 11, 2, 0, 2>
    HistogramDataPoint::_table_ = {
        ...
        {{
            ...
            // fixed64 count = 4;
            {::_pbi::TcParser::FastF64S1, {33, 63, 0, PROTOBUF_FIELD_OFFSET(HistogramDataPoint, _impl_.count_)}},
            // optional double sum = 5;
            {::_pbi::TcParser::FastF64S1, {41, 0, 0, PROTOBUF_FIELD_OFFSET(HistogramDataPoint, _impl_.sum_)}},
            ...
            {::_pbi::TcParser::FastMtR1, {66, 63, 0, PROTOBUF_FIELD_OFFSET(HistogramDataPoint, _impl_.exemplars_)}},
            // repeated .opentelemetry.proto.common.v1.KeyValue attributes = 9;
            {::_pbi::TcParser::FastMtR1, {74, 63, 1, PROTOBUF_FIELD_OFFSET(HistogramDataPoint, _impl_.attributes_)}},
            // uint32 flags = 10;
            ...
            {::_pbi::TcParser::FastF64S1, {89, 1, 0, PROTOBUF_FIELD_OFFSET(HistogramDataPoint, _impl_.min_)}},
            // optional double max = 12;
            {::_pbi::TcParser::FastF64S1, {97, 2, 0, PROTOBUF_FIELD_OFFSET(HistogramDataPoint, _impl_.max_)}},
            {::_pbi::TcParser::MiniParse, {}},
            {::_pbi::TcParser::MiniParse, {}},
            {::_pbi::TcParser::MiniParse, {}},
        }},
...
PROTOBUF_NOINLINE void HistogramDataPoint::Clear() {
	...
	::memset(&_impl_.start_time_unix_nano_, 0,
	         static_cast<::size_t>(reinterpret_cast<char *>(&_impl_.count_) -
	                               reinterpret_cast<char *>(&_impl_.start_time_unix_nano_)) +
	             sizeof(_impl_.count_));
	cached_has_bits = _impl_._has_bits_[0];
	if (cached_has_bits & 0x00000007u) {
		::memset(
		    &_impl_.sum_, 0,
		    static_cast<::size_t>(reinterpret_cast<char *>(&_impl_.max_) - reinterpret_cast<char *>(&_impl_.sum_)) +
		        sizeof(_impl_.max_));
	}
	_impl_.flags_ = 0u;
	_impl_._has_bits_.Clear();
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *HistogramDataPoint::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                                  ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const HistogramDataPoint &this_ = static_cast<const HistogramDataPoint &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *HistogramDataPoint::_InternalSerialize(::uint8_t *target,
                                                  ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	if (this_._internal_count() != 0) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteFixed64ToArray(4, this_._internal_count(), target);
	}
	...
	if (cached_has_bits & 0x00000001u) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteDoubleToArray(5, this_._internal_sum(), target);
	}
	...
	if (this_._internal_flags() != 0) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteUInt32ToArray(10, this_._internal_flags(), target);
	}

	// optional double min = 11;
	if (cached_has_bits & 0x00000002u) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteDoubleToArray(11, this_._internal_min(), target);
	}

	// optional double max = 12;
	if (cached_has_bits & 0x00000004u) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteDoubleToArray(12, this_._internal_max(), target);
	}
...
::size_t HistogramDataPoint::ByteSizeLong() const {
	...
	::_pbi::Prefetch5LinesFrom7Lines(&this_);
	{// repeated fixed64 bucket_counts = 6;
	 {std::size_t data_size = std::size_t {8} * ::_pbi::FromIntSize(this_._internal_bucket_counts_size());
	std::size_t tag_size = data_size == 0 ? 0 : 1 + ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
	total_size += tag_size + data_size;
}
// repeated double explicit_bounds = 7;
{
	std::size_t data_size = std::size_t {8} * ::_pbi::FromIntSize(this_._internal_explicit_bounds_size());
	std::size_t tag_size = data_size == 0 ? 0 : 1 + ::_pbi::WireFormatLite::Int32Size(static_cast<int32_t>(data_size));
	total_size += tag_size + data_size;
}
// repeated .opentelemetry.proto.metrics.v1.Exemplar exemplars = 8;
...
void HistogramDataPoint::InternalSwap(HistogramDataPoint *PROTOBUF_RESTRICT other) {
	...
	_impl_.exemplars_.InternalSwap(&other->_impl_.exemplars_);
	_impl_.attributes_.InternalSwap(&other->_impl_.attributes_);
	::google::protobuf::internal::memswap<PROTOBUF_FIELD_OFFSET(HistogramDataPoint, _impl_.flags_) +
...
inline PROTOBUF_NDEBUG_INLINE ExponentialHistogramDataPoint_Buckets::Impl_::Impl_(
    ...
    : bucket_counts_ {visibility, arena, from.bucket_counts_}, _bucket_counts_cached_byte_size_ {0}, _cached_size_ {0} {
}

ExponentialHistogramDataPoint_Buckets::ExponentialHistogramDataPoint_Buckets(
    ::google::protobuf::Arena *arena, const ExponentialHistogramDataPoint_Buckets &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
inline PROTOBUF_NDEBUG_INLINE
ExponentialHistogramDataPoint_Buckets::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                    ::google::protobuf::Arena *arena)
    : bucket_counts_ {visibility, arena}, _bucket_counts_cached_byte_size_ {0}, _cached_size_ {0} {
}
...
constexpr auto ExponentialHistogramDataPoint_Buckets::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(ExponentialHistogramDataPoint_Buckets, _impl_.bucket_counts_) +
	        decltype(ExponentialHistogramDataPoint_Buckets::_impl_.bucket_counts_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
...
const ::google::protobuf::internal::ClassDataFull ExponentialHistogramDataPoint_Buckets::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<ExponentialHistogramDataPoint_Buckets>(),
        &ExponentialHistogramDataPoint_Buckets::ByteSizeLong,
    ...
    ExponentialHistogramDataPoint_Buckets::_table_ = {
        {
            ...
            ::_pbi::TcParser::GetTable<
                ::opentelemetry::proto::metrics::v1::ExponentialHistogramDataPoint_Buckets>(), // to_prefetch
#endif // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *
ExponentialHistogramDataPoint_Buckets::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                                          ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const ExponentialHistogramDataPoint_Buckets &this_ =
	    static_cast<const ExponentialHistogramDataPoint_Buckets &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *
ExponentialHistogramDataPoint_Buckets::_InternalSerialize(::uint8_t *target,
                                                          ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	if (this_._internal_offset() != 0) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteSInt32ToArray(1, this_._internal_offset(), target);
	}
	...
	// repeated uint64 bucket_counts = 2;
	{
		...
		if (byte_size > 0) {
			target = stream->WriteUInt64Packed(2, this_._internal_bucket_counts(), byte_size, target);
		}
	}
...
::size_t ExponentialHistogramDataPoint_Buckets::ByteSizeLong() const {
	...
	::_pbi::Prefetch5LinesFrom7Lines(&this_);
	{// repeated uint64 bucket_counts = 2;
	 {total_size += ::_pbi::WireFormatLite::UInt64SizeWithPackedTagSize(this_._internal_bucket_counts(), 1,
...
}
{
	// sint32 offset = 1;
	if (this_._internal_offset() != 0) {
		total_size += ::_pbi::WireFormatLite::SInt32SizePlusOne(this_._internal_offset());
	}
}
return this_.MaybeComputeUnknownFieldsSize(total_size, &this_._impl_._cached_size_);
}
...
void ExponentialHistogramDataPoint_Buckets::InternalSwap(
    ExponentialHistogramDataPoint_Buckets *PROTOBUF_RESTRICT other) {
	using std::swap;
	_internal_metadata_.InternalSwap(&other->_internal_metadata_);
	_impl_.bucket_counts_.InternalSwap(&other->_impl_.bucket_counts_);
...
ExponentialHistogramDataPoint::ExponentialHistogramDataPoint(::google::protobuf::Arena *arena,
	...
	new (&_impl_) Impl_(internal_visibility(), arena, from._impl_, from);
	::uint32_t cached_has_bits = _impl_._has_bits_[0];
	_impl_.positive_ = (cached_has_bits & 0x00000001u)
	                       ...
	                       : nullptr;
	_impl_.negative_ = (cached_has_bits & 0x00000002u)
	                       ? ::google::protobuf::Message::CopyConstruct<
	                             ::opentelemetry::proto::metrics::v1::ExponentialHistogramDataPoint_Buckets>(
	...
	::memcpy(reinterpret_cast<char *>(&_impl_) + offsetof(Impl_, start_time_unix_nano_),
	         reinterpret_cast<const char *>(&from._impl_) + offsetof(Impl_, start_time_unix_nano_),
	         offsetof(Impl_, zero_threshold_) - offsetof(Impl_, start_time_unix_nano_) +
...
inline PROTOBUF_NDEBUG_INLINE
ExponentialHistogramDataPoint::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                            ::google::protobuf::Arena *arena)
    : _cached_size_ {0}, attributes_ {visibility, arena}, exemplars_ {visibility, arena} {
}

inline void ExponentialHistogramDataPoint::SharedCtor(::_pb::Arena *arena) {
	new (&_impl_) Impl_(internal_visibility(), arena);
	::memset(reinterpret_cast<char *>(&_impl_) + offsetof(Impl_, positive_), 0,
	         offsetof(Impl_, zero_threshold_) - offsetof(Impl_, positive_) + sizeof(Impl_::zero_threshold_));
}
...
inline void *ExponentialHistogramDataPoint::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
constexpr auto ExponentialHistogramDataPoint::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(ExponentialHistogramDataPoint, _impl_.attributes_) +
	        decltype(ExponentialHistogramDataPoint::_impl_.attributes_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	    PROTOBUF_FIELD_OFFSET(ExponentialHistogramDataPoint, _impl_.exemplars_) +
	        decltype(ExponentialHistogramDataPoint::_impl_.exemplars_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::ZeroInit(
...
const ::google::protobuf::internal::ClassDataFull ExponentialHistogramDataPoint::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<ExponentialHistogramDataPoint>(),
        &ExponentialHistogramDataPoint::ByteSizeLong,
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<4, 14, 4, 0, 2>
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::opentelemetry::proto::metrics::v1::ExponentialHistogramDataPoint>(), // to_prefetch
#endif                                                                                 // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
            {::_pbi::TcParser::MiniParse, {}},
            ...
            // uint32 flags = 10;
            {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(ExponentialHistogramDataPoint, _impl_.flags_),
                                                    63>(),
...
PROTOBUF_NOINLINE void ExponentialHistogramDataPoint::Clear() {
	...
	::memset(&_impl_.start_time_unix_nano_, 0,
	         static_cast<::size_t>(reinterpret_cast<char *>(&_impl_.count_) -
	             ...
	             sizeof(_impl_.count_));
	_impl_.sum_ = 0;
	::memset(&_impl_.zero_count_, 0,
	         static_cast<::size_t>(reinterpret_cast<char *>(&_impl_.flags_) -
	                               reinterpret_cast<char *>(&_impl_.zero_count_)) +
	             sizeof(_impl_.flags_));
	if (cached_has_bits & 0x00000018u) {
		::memset(
		    &_impl_.min_, 0,
		    static_cast<::size_t>(reinterpret_cast<char *>(&_impl_.max_) - reinterpret_cast<char *>(&_impl_.min_)) +
		        sizeof(_impl_.max_));
	}
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *ExponentialHistogramDataPoint::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                                             ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const ExponentialHistogramDataPoint &this_ = static_cast<const ExponentialHistogramDataPoint &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *
ExponentialHistogramDataPoint::_InternalSerialize(::uint8_t *target,
                                                  ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	if (this_._internal_scale() != 0) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteSInt32ToArray(6, this_._internal_scale(), target);
	}

	// fixed64 zero_count = 7;
	if (this_._internal_zero_count() != 0) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteFixed64ToArray(7, this_._internal_zero_count(), target);
	}

	// .opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint.Buckets positive = 8;
	if (cached_has_bits & 0x00000001u) {
		target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
		    8, *this_._impl_.positive_, this_._impl_.positive_->GetCachedSize(), target, stream);
	}

	// .opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint.Buckets negative = 9;
	if (cached_has_bits & 0x00000002u) {
		target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
		    9, *this_._impl_.negative_, this_._impl_.negative_->GetCachedSize(), target, stream);
	}
	...
	if (cached_has_bits & 0x00000008u) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteDoubleToArray(12, this_._internal_min(), target);
	}

	// optional double max = 13;
	if (cached_has_bits & 0x00000010u) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteDoubleToArray(13, this_._internal_max(), target);
	}

	// double zero_threshold = 14;
	if (::absl::bit_cast<::uint64_t>(this_._internal_zero_threshold()) != 0) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteDoubleToArray(14, this_._internal_zero_threshold(), target);
	}
...
::size_t ExponentialHistogramDataPoint::ByteSizeLong() const {
	...
	if (cached_has_bits & 0x00000003u) {
		// .opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint.Buckets positive = 8;
		if (cached_has_bits & 0x00000001u) {
			total_size += 1 + ::google::protobuf::internal::WireFormatLite::MessageSize(*this_._impl_.positive_);
		}
		// .opentelemetry.proto.metrics.v1.ExponentialHistogramDataPoint.Buckets negative = 9;
		if (cached_has_bits & 0x00000002u) {
			total_size += 1 + ::google::protobuf::internal::WireFormatLite::MessageSize(*this_._impl_.negative_);
		}
	}
	{
		// fixed64 start_time_unix_nano = 2;
	...
	}
	{
		...
		// sint32 scale = 6;
		if (this_._internal_scale() != 0) {
			total_size += ::_pbi::WireFormatLite::SInt32SizePlusOne(this_._internal_scale());
		}
		// uint32 flags = 10;
		if (this_._internal_flags() != 0) {
			total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this_._internal_flags());
	...
	if (cached_has_bits & 0x00000003u) {
		if (cached_has_bits & 0x00000001u) {
			...
			if (_this->_impl_.positive_ == nullptr) {
				_this->_impl_.positive_ = ::google::protobuf::Message::CopyConstruct<
				    ::opentelemetry::proto::metrics::v1::ExponentialHistogramDataPoint_Buckets>(arena,
				                                                                                *from._impl_.positive_);
			} else {
		...
		if (cached_has_bits & 0x00000002u) {
			...
			if (_this->_impl_.negative_ == nullptr) {
				_this->_impl_.negative_ = ::google::protobuf::Message::CopyConstruct<
				    ::opentelemetry::proto::metrics::v1::ExponentialHistogramDataPoint_Buckets>(arena,
				                                                                                *from._impl_.negative_);
			} else {
...
void ExponentialHistogramDataPoint::InternalSwap(ExponentialHistogramDataPoint *PROTOBUF_RESTRICT other) {
	...
	_impl_.attributes_.InternalSwap(&other->_impl_.attributes_);
	_impl_.exemplars_.InternalSwap(&other->_impl_.exemplars_);
	::google::protobuf::internal::memswap<PROTOBUF_FIELD_OFFSET(ExponentialHistogramDataPoint, _impl_.zero_threshold_) +
	    ...
	    reinterpret_cast<char *>(&_impl_.positive_), reinterpret_cast<char *>(&other->_impl_.positive_));
}
...
SummaryDataPoint_ValueAtQuantile::SummaryDataPoint_ValueAtQuantile(::google::protobuf::Arena *arena,
                                                                   const SummaryDataPoint_ValueAtQuantile &from)
    : SummaryDataPoint_ValueAtQuantile(arena) {
	MergeFrom(from);
}
inline PROTOBUF_NDEBUG_INLINE
SummaryDataPoint_ValueAtQuantile::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                               ::google::protobuf::Arena *arena)
    : _cached_size_ {0} {
}
...
inline void SummaryDataPoint_ValueAtQuantile::SharedCtor(::_pb::Arena *arena) {
	new (&_impl_) Impl_(internal_visibility(), arena);
	::memset(reinterpret_cast<char *>(&_impl_) + offsetof(Impl_, quantile_), 0,
	         offsetof(Impl_, value_) - offsetof(Impl_, quantile_) + sizeof(Impl_::value_));
}
...
const ::google::protobuf::internal::ClassDataFull SummaryDataPoint_ValueAtQuantile::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<SummaryDataPoint_ValueAtQuantile>(),
        &SummaryDataPoint_ValueAtQuantile::ByteSizeLong,
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::opentelemetry::proto::metrics::v1::SummaryDataPoint_ValueAtQuantile>(), // to_prefetch
#endif // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
            // double value = 2;
...
PROTOBUF_NOINLINE void SummaryDataPoint_ValueAtQuantile::Clear() {
	...
	::memset(
	    &_impl_.quantile_, 0,
	    static_cast<::size_t>(reinterpret_cast<char *>(&_impl_.value_) - reinterpret_cast<char *>(&_impl_.quantile_)) +
	        sizeof(_impl_.value_));
	_internal_metadata_.Clear<::google::protobuf::UnknownFieldSet>();
}

#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *SummaryDataPoint_ValueAtQuantile::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                                                ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const SummaryDataPoint_ValueAtQuantile &this_ = static_cast<const SummaryDataPoint_ValueAtQuantile &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *
SummaryDataPoint_ValueAtQuantile::_InternalSerialize(::uint8_t *target,
                                                     ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	if (::absl::bit_cast<::uint64_t>(this_._internal_quantile()) != 0) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteDoubleToArray(1, this_._internal_quantile(), target);
	}

	// double value = 2;
	if (::absl::bit_cast<::uint64_t>(this_._internal_value()) != 0) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteDoubleToArray(2, this_._internal_value(), target);
	}
...
void SummaryDataPoint_ValueAtQuantile::InternalSwap(SummaryDataPoint_ValueAtQuantile *PROTOBUF_RESTRICT other) {
	using std::swap;
	_internal_metadata_.InternalSwap(&other->_internal_metadata_);
	::google::protobuf::internal::memswap<PROTOBUF_FIELD_OFFSET(SummaryDataPoint_ValueAtQuantile, _impl_.value_) +
	    ...
	    reinterpret_cast<char *>(&_impl_.quantile_), reinterpret_cast<char *>(&other->_impl_.quantile_));
}
...
inline PROTOBUF_NDEBUG_INLINE
SummaryDataPoint::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                               ::google::protobuf::Arena *arena, const Impl_ &from,
                               const ::opentelemetry::proto::metrics::v1::SummaryDataPoint &from_msg)
    : quantile_values_ {visibility, arena, from.quantile_values_}, attributes_ {visibility, arena, from.attributes_},
      _cached_size_ {0} {
}

SummaryDataPoint::SummaryDataPoint(::google::protobuf::Arena *arena, const SummaryDataPoint &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
SummaryDataPoint::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                               ::google::protobuf::Arena *arena)
    : quantile_values_ {visibility, arena}, attributes_ {visibility, arena}, _cached_size_ {0} {
}
...
inline void *SummaryDataPoint::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
constexpr auto SummaryDataPoint::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(SummaryDataPoint, _impl_.attributes_) +
	        decltype(SummaryDataPoint::_impl_.attributes_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	    PROTOBUF_FIELD_OFFSET(SummaryDataPoint, _impl_.quantile_values_) +
	        decltype(SummaryDataPoint::_impl_.quantile_values_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(SummaryDataPoint),
		                                                              alignof(SummaryDataPoint), *arena_bits);
	} else {
		return ::google::protobuf::internal::MessageCreator(&SummaryDataPoint::PlacementNew_, sizeof(SummaryDataPoint),
...
const ::google::protobuf::internal::ClassDataFull SummaryDataPoint::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<SummaryDataPoint>(),
        &SummaryDataPoint::ByteSizeLong,
        &SummaryDataPoint::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(SummaryDataPoint, _impl_._cached_size_),
        false,
    },
    &SummaryDataPoint::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<3, 7, 2, 0, 2>
    SummaryDataPoint::_table_ = {
        ...
        {{
            ...
            // fixed64 time_unix_nano = 3;
            {::_pbi::TcParser::FastF64S1, {25, 63, 0, PROTOBUF_FIELD_OFFSET(SummaryDataPoint, _impl_.time_unix_nano_)}},
            // fixed64 count = 4;
            {::_pbi::TcParser::FastF64S1, {33, 63, 0, PROTOBUF_FIELD_OFFSET(SummaryDataPoint, _impl_.count_)}},
            // double sum = 5;
            {::_pbi::TcParser::FastF64S1, {41, 63, 0, PROTOBUF_FIELD_OFFSET(SummaryDataPoint, _impl_.sum_)}},
            // repeated .opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile quantile_values = 6;
            {::_pbi::TcParser::FastMtR1, {50, 63, 0, PROTOBUF_FIELD_OFFSET(SummaryDataPoint, _impl_.quantile_values_)}},
            // repeated .opentelemetry.proto.common.v1.KeyValue attributes = 7;
            {::_pbi::TcParser::FastMtR1, {58, 63, 1, PROTOBUF_FIELD_OFFSET(SummaryDataPoint, _impl_.attributes_)}},
        }},
        {{65535, 65535}},
        {{
            // fixed64 start_time_unix_nano = 2;
            ...
            {PROTOBUF_FIELD_OFFSET(SummaryDataPoint, _impl_.time_unix_nano_), 0, 0,
             (0 | ::_fl::kFcSingular | ::_fl::kFixed64)},
            // fixed64 count = 4;
            {PROTOBUF_FIELD_OFFSET(SummaryDataPoint, _impl_.count_), 0, 0, (0 | ::_fl::kFcSingular | ::_fl::kFixed64)},
            // double sum = 5;
            {PROTOBUF_FIELD_OFFSET(SummaryDataPoint, _impl_.sum_), 0, 0, (0 | ::_fl::kFcSingular | ::_fl::kDouble)},
            // repeated .opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile quantile_values = 6;
            ...
            {PROTOBUF_FIELD_OFFSET(SummaryDataPoint, _impl_.attributes_), 0, 1,
             (0 | ::_fl::kFcRepeated | ::_fl::kMessage | ::_fl::kTvTable)},
            // uint32 flags = 8;
            {PROTOBUF_FIELD_OFFSET(SummaryDataPoint, _impl_.flags_), 0, 0, (0 | ::_fl::kFcSingular | ::_fl::kUInt32)},
        }},
        {{
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *SummaryDataPoint::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                                ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const SummaryDataPoint &this_ = static_cast<const SummaryDataPoint &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *SummaryDataPoint::_InternalSerialize(::uint8_t *target,
                                                ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	// repeated .opentelemetry.proto.metrics.v1.SummaryDataPoint.ValueAtQuantile quantile_values = 6;
	for (unsigned i = 0, n = static_cast<unsigned>(this_._internal_quantile_values_size()); i < n; i++) {
...
void SummaryDataPoint::InternalSwap(SummaryDataPoint *PROTOBUF_RESTRICT other) {
	...
	_impl_.attributes_.InternalSwap(&other->_impl_.attributes_);
	::google::protobuf::internal::memswap<PROTOBUF_FIELD_OFFSET(SummaryDataPoint, _impl_.flags_) +
...
inline PROTOBUF_NDEBUG_INLINE Exemplar::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                     ::google::protobuf::Arena *arena, const Impl_ &from,
                                                     const ::opentelemetry::proto::metrics::v1::Exemplar &from_msg)
    : filtered_attributes_ {visibility, arena, from.filtered_attributes_}, span_id_(arena, from.span_id_),
      trace_id_(arena, from.trace_id_), value_ {}, _cached_size_ {0}, _oneof_case_ {from._oneof_case_[0]} {
}

Exemplar::Exemplar(::google::protobuf::Arena *arena, const Exemplar &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
inline PROTOBUF_NDEBUG_INLINE Exemplar::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                     ::google::protobuf::Arena *arena)
    : filtered_attributes_ {visibility, arena}, span_id_(arena),
      trace_id_(arena), value_ {}, _cached_size_ {0}, _oneof_case_ {} {
}
...
inline void *Exemplar::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
constexpr auto Exemplar::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(Exemplar, _impl_.filtered_attributes_) +
	        decltype(Exemplar::_impl_.filtered_attributes_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(Exemplar), alignof(Exemplar), *arena_bits);
	} else {
		return ::google::protobuf::internal::MessageCreator(&Exemplar::PlacementNew_, sizeof(Exemplar),
		                                                    alignof(Exemplar));
	}
}
PROTOBUF_CONSTINIT
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &Exemplar::SharedDtor,
        ::google::protobuf::Message::GetClearImpl<Exemplar>(),
        &Exemplar::ByteSizeLong,
        &Exemplar::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(Exemplar, _impl_._cached_size_),
        false,
    },
    &Exemplar::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fmetrics_2fv1_2fmetrics_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<2, 6, 1, 0, 2> Exemplar::_table_ = {
    {
        0,     // no _has_bits_
        0,     // no _extensions_
    ...
    {{
        // bytes span_id = 4;
        {::_pbi::TcParser::FastBS1, {34, 63, 0, PROTOBUF_FIELD_OFFSET(Exemplar, _impl_.span_id_)}},
        // bytes trace_id = 5;
        {::_pbi::TcParser::FastBS1, {42, 63, 0, PROTOBUF_FIELD_OFFSET(Exemplar, _impl_.trace_id_)}},
        // fixed64 time_unix_nano = 2;
        {::_pbi::TcParser::FastF64S1, {17, 63, 0, PROTOBUF_FIELD_OFFSET(Exemplar, _impl_.time_unix_nano_)}},
        // repeated .opentelemetry.proto.common.v1.KeyValue filtered_attributes = 7;
        {::_pbi::TcParser::FastMtR1, {58, 63, 0, PROTOBUF_FIELD_OFFSET(Exemplar, _impl_.filtered_attributes_)}},
    }},
    {{65535, 65535}},
    {{
        // fixed64 time_unix_nano = 2;
        {PROTOBUF_FIELD_OFFSET(Exemplar, _impl_.time_unix_nano_), 0, 0, (0 | ::_fl::kFcSingular | ::_fl::kFixed64)},
        // double as_double = 3;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *Exemplar::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                        ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const Exemplar &this_ = static_cast<const Exemplar &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *Exemplar::_InternalSerialize(::uint8_t *target, ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	if (this_._internal_time_unix_nano() != 0) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteFixed64ToArray(2, this_._internal_time_unix_nano(), target);
	}

	// double as_double = 3;
	if (this_.value_case() == kAsDouble) {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteDoubleToArray(3, this_._internal_as_double(), target);
	}
	...
	// repeated .opentelemetry.proto.common.v1.KeyValue filtered_attributes = 7;
	for (unsigned i = 0, n = static_cast<unsigned>(this_._internal_filtered_attributes_size()); i < n; i++) {
