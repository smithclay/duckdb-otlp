...
inline constexpr AnyValue::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : value_ {}, _cached_size_ {0}, _oneof_case_ {} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AnyValueDefaultTypeInternal
    _AnyValue_default_instance_;

inline constexpr ArrayValue::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept : values_ {}, _cached_size_ {0} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 ArrayValueDefaultTypeInternal
    _ArrayValue_default_instance_;

inline constexpr KeyValue::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : _cached_size_ {0},
      key_(&::google::protobuf::internal::fixed_address_empty_string, ::_pbi::ConstantInitialized()), value_ {nullptr} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 KeyValueDefaultTypeInternal
    _KeyValue_default_instance_;

inline constexpr KeyValueList::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept : values_ {}, _cached_size_ {0} {
}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 KeyValueListDefaultTypeInternal
    _KeyValueList_default_instance_;

inline constexpr InstrumentationScope::Impl_::Impl_(::_pbi::ConstantInitialized) noexcept
    : attributes_ {}, name_(&::google::protobuf::internal::fixed_address_empty_string, ::_pbi::ConstantInitialized()),
      version_(&::google::protobuf::internal::fixed_address_empty_string, ::_pbi::ConstantInitialized()),
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
    InstrumentationScopeDefaultTypeInternal _InstrumentationScope_default_instance_;
} // namespace v1
} // namespace common
} // namespace proto
} // namespace opentelemetry
...
const ::uint32_t
    TableStruct_opentelemetry_2fproto_2fcommon_2fv1_2fcommon_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::opentelemetry::proto::common::v1::InstrumentationScope,
...
const char
    descriptor_table_protodef_opentelemetry_2fproto_2fcommon_2fv1_2fcommon_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
...
inline PROTOBUF_NDEBUG_INLINE AnyValue::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                     ::google::protobuf::Arena *arena, const Impl_ &from,
                                                     const ::opentelemetry::proto::common::v1::AnyValue &from_msg)
    : value_ {}, _cached_size_ {0}, _oneof_case_ {from._oneof_case_[0]} {
}

AnyValue::AnyValue(::google::protobuf::Arena *arena, const AnyValue &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
	...
	case VALUE_NOT_SET:
		break;
	case kStringValue:
		new (&_impl_.value_.string_value_) decltype(_impl_.value_.string_value_) {arena,
		                                                                          from._impl_.value_.string_value_};
		break;
	case kBoolValue:
	...
	case kArrayValue:
		_impl_.value_.array_value_ =
		    ::google::protobuf::Message::CopyConstruct<::opentelemetry::proto::common::v1::ArrayValue>(
		        arena, *from._impl_.value_.array_value_);
		break;
	case kKvlistValue:
		_impl_.value_.kvlist_value_ =
		    ::google::protobuf::Message::CopyConstruct<::opentelemetry::proto::common::v1::KeyValueList>(
		        arena, *from._impl_.value_.kvlist_value_);
		break;
	case kBytesValue:
...
inline void *AnyValue::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &AnyValue::SharedDtor,
        ::google::protobuf::Message::GetClearImpl<AnyValue>(),
        &AnyValue::ByteSizeLong,
        &AnyValue::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(AnyValue, _impl_._cached_size_),
        false,
    },
    &AnyValue::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fcommon_2fv1_2fcommon_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 7, 2, 59, 2> AnyValue::_table_ = {
    {
        0,    // no _has_bits_
        0,    // no _extensions_
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *AnyValue::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                        ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const AnyValue &this_ = static_cast<const AnyValue &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *AnyValue::_InternalSerialize(::uint8_t *target, ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	case kBoolValue: {
		...
		target = ::_pbi::WireFormatLite::WriteBoolToArray(2, this_._internal_bool_value(), target);
		break;
	}
	case kIntValue: {
	...
	case kDoubleValue: {
		target = stream->EnsureSpace(target);
		target = ::_pbi::WireFormatLite::WriteDoubleToArray(4, this_._internal_double_value(), target);
		break;
	}
	case kArrayValue: {
		target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
		    5, *this_._impl_.value_.array_value_, this_._impl_.value_.array_value_->GetCachedSize(), target, stream);
		break;
	}
	case kKvlistValue: {
		target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
		    6, *this_._impl_.value_.kvlist_value_, this_._impl_.value_.kvlist_value_->GetCachedSize(), target, stream);
		break;
	}
	case kBytesValue: {
...
::size_t AnyValue::ByteSizeLong() const {
	...
	// string string_value = 1;
	case kStringValue: {
		total_size += 1 + ::google::protobuf::internal::WireFormatLite::StringSize(this_._internal_string_value());
		break;
	}
	// bool bool_value = 2;
	case kBoolValue: {
	...
	// int64 int_value = 3;
	case kIntValue: {
		total_size += ::_pbi::WireFormatLite::Int64SizePlusOne(this_._internal_int_value());
		break;
	}
	// double double_value = 4;
	case kDoubleValue: {
	...
	// .opentelemetry.proto.common.v1.ArrayValue array_value = 5;
	case kArrayValue: {
		total_size += 1 + ::google::protobuf::internal::WireFormatLite::MessageSize(*this_._impl_.value_.array_value_);
		break;
	}
	// .opentelemetry.proto.common.v1.KeyValueList kvlist_value = 6;
	case kKvlistValue: {
		total_size += 1 + ::google::protobuf::internal::WireFormatLite::MessageSize(*this_._impl_.value_.kvlist_value_);
		break;
	}
	// bytes bytes_value = 7;
	case kBytesValue: {
		total_size += 1 + ::google::protobuf::internal::WireFormatLite::BytesSize(this_._internal_bytes_value());
		break;
	}
	case VALUE_NOT_SET: {
		break;
...
inline PROTOBUF_NDEBUG_INLINE ArrayValue::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                       ::google::protobuf::Arena *arena, const Impl_ &from,
                                                       const ::opentelemetry::proto::common::v1::ArrayValue &from_msg)
    : values_ {visibility, arena, from.values_}, _cached_size_ {0} {
}

ArrayValue::ArrayValue(::google::protobuf::Arena *arena, const ArrayValue &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
inline PROTOBUF_NDEBUG_INLINE ArrayValue::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                       ::google::protobuf::Arena *arena)
    : values_ {visibility, arena}, _cached_size_ {0} {
}
...
inline void *ArrayValue::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
constexpr auto ArrayValue::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(ArrayValue, _impl_.values_) +
	        decltype(ArrayValue::_impl_.values_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(ArrayValue), alignof(ArrayValue),
		                                                              *arena_bits);
	} else {
		return ::google::protobuf::internal::MessageCreator(&ArrayValue::PlacementNew_, sizeof(ArrayValue),
		                                                    alignof(ArrayValue));
	}
}
PROTOBUF_CONSTINIT
...
const ::google::protobuf::internal::ClassDataFull ArrayValue::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<ArrayValue>(),
        &ArrayValue::ByteSizeLong,
        &ArrayValue::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(ArrayValue, _impl_._cached_size_),
        false,
    },
    &ArrayValue::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fcommon_2fv1_2fcommon_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 1, 1, 0, 2> ArrayValue::_table_ = {
    {
        0,    // no _has_bits_
        0,    // no _extensions_
    ...
    {{
        ...
        {::_pbi::TcParser::FastMtR1, {10, 63, 0, PROTOBUF_FIELD_OFFSET(ArrayValue, _impl_.values_)}},
    }},
    {{65535, 65535}},
    {{
        // repeated .opentelemetry.proto.common.v1.AnyValue values = 1;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *ArrayValue::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                          ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const ArrayValue &this_ = static_cast<const ArrayValue &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *ArrayValue::_InternalSerialize(::uint8_t *target,
	...
	// repeated .opentelemetry.proto.common.v1.AnyValue values = 1;
	for (unsigned i = 0, n = static_cast<unsigned>(this_._internal_values_size()); i < n; i++) {
...
KeyValueList::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                           ::google::protobuf::Arena *arena, const Impl_ &from,
                           const ::opentelemetry::proto::common::v1::KeyValueList &from_msg)
    : values_ {visibility, arena, from.values_}, _cached_size_ {0} {
}

KeyValueList::KeyValueList(::google::protobuf::Arena *arena, const KeyValueList &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
inline PROTOBUF_NDEBUG_INLINE KeyValueList::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                         ::google::protobuf::Arena *arena)
    : values_ {visibility, arena}, _cached_size_ {0} {
}
...
inline void *KeyValueList::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
constexpr auto KeyValueList::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(KeyValueList, _impl_.values_) +
	        decltype(KeyValueList::_impl_.values_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::ZeroInit(sizeof(KeyValueList), alignof(KeyValueList),
		                                                              *arena_bits);
	} else {
		return ::google::protobuf::internal::MessageCreator(&KeyValueList::PlacementNew_, sizeof(KeyValueList),
...
const ::google::protobuf::internal::ClassDataFull KeyValueList::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<KeyValueList>(),
        &KeyValueList::ByteSizeLong,
        &KeyValueList::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(KeyValueList, _impl_._cached_size_),
        false,
    },
    &KeyValueList::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fcommon_2fv1_2fcommon_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 1, 1, 0, 2> KeyValueList::_table_ = {
    {
        0,    // no _has_bits_
        0,    // no _extensions_
        1, 0, // max_field_number, fast_idx_mask
    ...
    {{
        ...
        {::_pbi::TcParser::FastMtR1, {10, 63, 0, PROTOBUF_FIELD_OFFSET(KeyValueList, _impl_.values_)}},
    }},
    {{65535, 65535}},
    {{
        // repeated .opentelemetry.proto.common.v1.KeyValue values = 1;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *KeyValueList::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                            ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const KeyValueList &this_ = static_cast<const KeyValueList &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *KeyValueList::_InternalSerialize(::uint8_t *target,
                                            ::google::protobuf::io::EpsCopyOutputStream *stream) const {
...
public:
	...
	static constexpr ::int32_t kHasBitsOffset = 8 * PROTOBUF_FIELD_OFFSET(KeyValue, _impl_._has_bits_);
};
...
inline PROTOBUF_NDEBUG_INLINE KeyValue::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                                     ::google::protobuf::Arena *arena, const Impl_ &from,
                                                     const ::opentelemetry::proto::common::v1::KeyValue &from_msg)
    : _has_bits_ {from._has_bits_}, _cached_size_ {0}, key_(arena, from.key_) {
}

KeyValue::KeyValue(::google::protobuf::Arena *arena, const KeyValue &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
inline void *KeyValue::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &KeyValue::SharedDtor,
        ::google::protobuf::Message::GetClearImpl<KeyValue>(),
        &KeyValue::ByteSizeLong,
        &KeyValue::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(KeyValue, _impl_._cached_size_),
        false,
    },
    &KeyValue::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fcommon_2fv1_2fcommon_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<1, 2, 1, 50, 2> KeyValue::_table_ = {
    {
    ...
    {{
        ...
        {::_pbi::TcParser::FastMtS1, {18, 0, 0, PROTOBUF_FIELD_OFFSET(KeyValue, _impl_.value_)}},
        // string key = 1;
        {::_pbi::TcParser::FastUS1, {10, 63, 0, PROTOBUF_FIELD_OFFSET(KeyValue, _impl_.key_)}},
    }},
    {{65535, 65535}},
    {{
        // string key = 1;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *KeyValue::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                        ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const KeyValue &this_ = static_cast<const KeyValue &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *KeyValue::_InternalSerialize(::uint8_t *target, ::google::protobuf::io::EpsCopyOutputStream *stream) const {
	...
	if (cached_has_bits & 0x00000001u) {
		target = ::google::protobuf::internal::WireFormatLite::InternalWriteMessage(
		    2, *this_._impl_.value_, this_._impl_.value_->GetCachedSize(), target, stream);
	}
...
::size_t KeyValue::ByteSizeLong() const {
	...
	::_pbi::Prefetch5LinesFrom7Lines(&this_);
	{
		// string key = 1;
		if (!this_._internal_key().empty()) {
			total_size += 1 + ::google::protobuf::internal::WireFormatLite::StringSize(this_._internal_key());
		}
	}
	{
		// .opentelemetry.proto.common.v1.AnyValue value = 2;
		cached_has_bits = this_._impl_._has_bits_[0];
		if (cached_has_bits & 0x00000001u) {
			total_size += 1 + ::google::protobuf::internal::WireFormatLite::MessageSize(*this_._impl_.value_);
		}
	}
	return this_.MaybeComputeUnknownFieldsSize(total_size, &this_._impl_._cached_size_);
}
...
inline PROTOBUF_NDEBUG_INLINE
InstrumentationScope::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                   ::google::protobuf::Arena *arena, const Impl_ &from,
                                   const ::opentelemetry::proto::common::v1::InstrumentationScope &from_msg)
    : attributes_ {visibility, arena, from.attributes_}, name_(arena, from.name_),
      version_(arena, from.version_), _cached_size_ {0} {
}

InstrumentationScope::InstrumentationScope(::google::protobuf::Arena *arena, const InstrumentationScope &from)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else  // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
...
InstrumentationScope::Impl_::Impl_(::google::protobuf::internal::InternalVisibility visibility,
                                   ::google::protobuf::Arena *arena)
    : attributes_ {visibility, arena}, name_(arena), version_(arena), _cached_size_ {0} {
}
...
inline void *InstrumentationScope::PlacementNew_(const void *, void *mem, ::google::protobuf::Arena *arena) {
...
constexpr auto InstrumentationScope::InternalNewImpl_() {
	constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
	    PROTOBUF_FIELD_OFFSET(InstrumentationScope, _impl_.attributes_) +
	        decltype(InstrumentationScope::_impl_.attributes_)::InternalGetArenaOffset(
	            ::google::protobuf::Message::internal_visibility()),
	});
	if (arena_bits.has_value()) {
		return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(InstrumentationScope),
		                                                              alignof(InstrumentationScope), *arena_bits);
	} else {
		return ::google::protobuf::internal::MessageCreator(
		    &InstrumentationScope::PlacementNew_, sizeof(InstrumentationScope), alignof(InstrumentationScope));
	}
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull InstrumentationScope::_class_data_ = {
    ::google::protobuf::internal::ClassData {
        ...
        ::google::protobuf::Message::GetClearImpl<InstrumentationScope>(),
        &InstrumentationScope::ByteSizeLong,
        &InstrumentationScope::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(InstrumentationScope, _impl_._cached_size_),
        false,
    },
    &InstrumentationScope::kDescriptorMethods, &descriptor_table_opentelemetry_2fproto_2fcommon_2fv1_2fcommon_2eproto,
    nullptr, // tracker
};
    ...
    InstrumentationScope::_table_ = {
        ...
        {{
            ...
            {::_pbi::TcParser::SingularVarintNoZag1<
                 ::uint32_t, offsetof(InstrumentationScope, _impl_.dropped_attributes_count_), 63>(),
             {32, 63, 0, PROTOBUF_FIELD_OFFSET(InstrumentationScope, _impl_.dropped_attributes_count_)}},
            // string name = 1;
            {::_pbi::TcParser::FastUS1, {10, 63, 0, PROTOBUF_FIELD_OFFSET(InstrumentationScope, _impl_.name_)}},
            // string version = 2;
            {::_pbi::TcParser::FastUS1, {18, 63, 0, PROTOBUF_FIELD_OFFSET(InstrumentationScope, _impl_.version_)}},
            // repeated .opentelemetry.proto.common.v1.KeyValue attributes = 3;
            {::_pbi::TcParser::FastMtR1, {26, 63, 0, PROTOBUF_FIELD_OFFSET(InstrumentationScope, _impl_.attributes_)}},
        }},
        {{65535, 65535}},
        {{
            // string name = 1;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t *InstrumentationScope::_InternalSerialize(const MessageLite &base, ::uint8_t *target,
                                                    ::google::protobuf::io::EpsCopyOutputStream *stream) {
	const InstrumentationScope &this_ = static_cast<const InstrumentationScope &>(base);
#else  // PROTOBUF_CUSTOM_VTABLE
::uint8_t *InstrumentationScope::_InternalSerialize(::uint8_t *target,
                                                    ::google::protobuf::io::EpsCopyOutputStream *stream) const {
