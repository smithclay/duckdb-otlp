...
# stale archive. List the crate's tracked sources and manifest so any content
# change relinks. CONFIGURE_DEPENDS re-globs at build time so added/removed .rs
# files are picked up without a manual re-configure. Cargo.lock is intentionally
# NOT listed: it is gitignored in the crate (generated by the first build), so a
# fresh checkout has none and ninja would fail with "missing and no known rule
# to make it"; Cargo.toml changes already cover dependency bumps.
